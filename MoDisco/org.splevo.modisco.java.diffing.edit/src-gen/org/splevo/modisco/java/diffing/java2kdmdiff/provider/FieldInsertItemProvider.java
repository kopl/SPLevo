...
/**
 * This is the item provider adapter for a {@link org.splevo.modisco.java.diffing.java2kdmdiff.FieldInsert} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldInsertItemProvider extends FieldChangeItemProvider implements
	...
	protected void addFieldLeftPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_FieldInsert_fieldLeft_feature",
						"_UI_FieldInsert_type"),
				Java2KDMDiffPackage.Literals.FIELD_INSERT__FIELD_LEFT, true,
	...
	public String getText(Object object) {
		...
		if (fieldInsert.getFieldLeft() != null) {
			...
			if (fieldInsert.getFieldLeft().getFragments().size() > 0) {
				for (VariableDeclarationFragment fragment : fieldInsert
