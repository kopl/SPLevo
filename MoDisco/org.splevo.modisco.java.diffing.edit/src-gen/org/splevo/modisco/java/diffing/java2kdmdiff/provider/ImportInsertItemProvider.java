...
/**
 * This is the item provider adapter for a {@link org.splevo.modisco.java.diffing.java2kdmdiff.ImportInsert} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportInsertItemProvider extends
	...
	protected void addImportLeftPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ImportInsert_importLeft_feature",
						"_UI_ImportInsert_type"),
				Java2KDMDiffPackage.Literals.IMPORT_INSERT__IMPORT_LEFT, true,
	...
	public Object getImage(Object object) {
		...
		if (importInsert.getImportLeft() != null) {
			return ImageUtil.getASTInsertIcon(importInsert.getImportLeft(),
					this);
		} else {
	...
	public String getText(Object object) {
		...
		String importName = "";
		if (importInsert.getImportLeft() != null) {
			importName = importInsert.getImportLeft().getImportedElement()
					.getName();
		}
