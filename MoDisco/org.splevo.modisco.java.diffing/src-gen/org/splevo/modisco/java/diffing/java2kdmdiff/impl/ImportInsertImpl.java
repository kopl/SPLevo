 ...
 * <ul>
 *   <li>{@link org.splevo.modisco.java.diffing.java2kdmdiff.impl.ImportInsertImpl#getImportLeft <em>Import Left</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ImportInsertImpl extends ImportDeclarationChangeImpl implements
		ImportInsert {
	/**
			...
			if (importLeft != oldImportLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Java2KDMDiffPackage.IMPORT_INSERT__IMPORT_LEFT,
