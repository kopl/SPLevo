 ...
 * <ul>
 *   <li>{@link org.splevo.modisco.java.diffing.java2kdmdiff.impl.EnumDeclarationChangeImpl#getEnumLeft <em>Enum Left</em>}</li>
 *   <li>{@link org.splevo.modisco.java.diffing.java2kdmdiff.impl.EnumDeclarationChangeImpl#getEnumRight <em>Enum Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnumDeclarationChangeImpl extends EnumChangeImpl implements
			...
			if (enumLeft != oldEnumLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							Java2KDMDiffPackage.ENUM_DECLARATION_CHANGE__ENUM_LEFT,
							oldEnumLeft, enumLeft));
			}
		}
		return enumLeft;
	}
			...
			if (enumRight != oldEnumRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							Java2KDMDiffPackage.ENUM_DECLARATION_CHANGE__ENUM_RIGHT,
							oldEnumRight, enumRight));
			}
		}
		return enumRight;
	}
