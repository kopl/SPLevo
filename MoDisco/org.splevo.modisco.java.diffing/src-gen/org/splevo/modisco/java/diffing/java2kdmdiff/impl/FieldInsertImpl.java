 ...
 * <ul>
 *   <li>{@link org.splevo.modisco.java.diffing.java2kdmdiff.impl.FieldInsertImpl#getFieldLeft <em>Field Left</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
			...
			if (fieldLeft != oldFieldLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Java2KDMDiffPackage.FIELD_INSERT__FIELD_LEFT,
	...
	public void setFieldLeft(FieldDeclaration newFieldLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Java2KDMDiffPackage.FIELD_INSERT__FIELD_LEFT, oldFieldLeft,
					fieldLeft));
	}
