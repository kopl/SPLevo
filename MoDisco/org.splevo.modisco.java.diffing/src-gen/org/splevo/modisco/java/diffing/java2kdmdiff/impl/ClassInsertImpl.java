 ...
 * <ul>
 *   <li>{@link org.splevo.modisco.java.diffing.java2kdmdiff.impl.ClassInsertImpl#getClassLeft <em>Class Left</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
			...
			if (classLeft != oldClassLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Java2KDMDiffPackage.CLASS_INSERT__CLASS_LEFT,
	...
	public void setClassLeft(ClassDeclaration newClassLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Java2KDMDiffPackage.CLASS_INSERT__CLASS_LEFT, oldClassLeft,
					classLeft));
	}
