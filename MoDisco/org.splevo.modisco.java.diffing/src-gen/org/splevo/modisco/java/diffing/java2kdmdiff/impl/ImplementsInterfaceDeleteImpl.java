 ...
 * <ul>
 *   <li>{@link org.splevo.modisco.java.diffing.java2kdmdiff.impl.ImplementsInterfaceDeleteImpl#getImplementedInterface <em>Implemented Interface</em>}</li>
 *   <li>{@link org.splevo.modisco.java.diffing.java2kdmdiff.impl.ImplementsInterfaceDeleteImpl#getChangedClass <em>Changed Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ImplementsInterfaceDeleteImpl extends ClassChangeImpl implements
			...
			if (changedClass != oldChangedClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__CHANGED_CLASS,
