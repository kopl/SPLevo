...
/**
 * This class is responsible to check a java model element if it is located in a
 * package that should be ignored.
 * 
 * Internally, it makes use of a visitor based on a EMF generated switch for the
 * java model to improve the performance of the EObject analysis.
 */
...
public class PackageIgnoreChecker {
	 ...
	 *            The list of packages to be ignored. Regular expressions are
	 *            excepted.
	 */
