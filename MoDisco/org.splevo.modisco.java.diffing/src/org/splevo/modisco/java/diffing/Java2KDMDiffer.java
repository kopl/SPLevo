 ...
 *
 */
public class Java2KDMDiffer implements Differ {

    private static final String LABEL = "MoDisco-based Java Differ";
    private static final String ID = "org.splevo.modisco.java.differ";
    public static final String OPTION_JAVA_IGNORE_PACKAGES = "MoDisco.Java.Packages.to.ignore";
    private Logger logger = Logger.getLogger(Java2KDMDiffer.class);

    /**
     * Load the MoDisco resource sets and trigger the ResourceSet-based doDiff method.<br>
     *
     * {@inheritDoc}
     */
    @Override
