...
public class softwareSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case softwarePackage.MO_DISCO_JAVA_SOFTWARE_ELEMENT: {
            MoDiscoJavaSoftwareElement moDiscoJavaSoftwareElement = (MoDiscoJavaSoftwareElement) theEObject;
            T result = caseMoDiscoJavaSoftwareElement(moDiscoJavaSoftwareElement);
            if (result == null)
                result = caseJavaSoftwareElement(moDiscoJavaSoftwareElement);
            if (result == null)
                result = caseSoftwareElement(moDiscoJavaSoftwareElement);
            if (result == null)
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Mo Disco Java Software Element</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Mo Disco Java Software Element</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseMoDiscoJavaSoftwareElement(MoDiscoJavaSoftwareElement object) {
        return null;
    }
