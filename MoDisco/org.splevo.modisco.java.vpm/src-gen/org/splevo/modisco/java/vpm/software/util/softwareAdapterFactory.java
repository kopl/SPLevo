/**
 */
package org.splevo.modisco.java.vpm.software.util;
...
public class softwareAdapterFactory extends AdapterFactoryImpl {
    ...
    protected softwareSwitch<Adapter> modelSwitch = new softwareSwitch<Adapter>() {
        @Override
        public Adapter caseMoDiscoJavaSoftwareElement(MoDiscoJavaSoftwareElement object) {
            return createMoDiscoJavaSoftwareElementAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.splevo.modisco.java.vpm.software.MoDiscoJavaSoftwareElement <em>Mo Disco Java Software Element</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createMoDiscoJavaSoftwareElementAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.splevo.vpm.software.SoftwareElement <em>Element</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.splevo.vpm.software.JavaSoftwareElement <em>Java Software Element</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
