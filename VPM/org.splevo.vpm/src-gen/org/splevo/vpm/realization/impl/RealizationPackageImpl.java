 ...
 * @generated
 */
public class RealizationPackageImpl extends EPackageImpl implements
		RealizationPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public static RealizationPackage init() {
		if (isInited)
			return (RealizationPackage) EPackage.Registry.INSTANCE
		...
		RealizationPackageImpl theRealizationPackage = (RealizationPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof RealizationPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new RealizationPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(RealizationPackage.eNS_URI,
				theRealizationPackage);
	...
	public EAttribute getVariabilityMechanism_Name() {
		return (EAttribute) variabilityMechanismEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(variabilityMechanismEClass,
				VARIABILITY_MECHANISM__NAME);
		createEAttribute(variabilityMechanismEClass,
				VARIABILITY_MECHANISM__REFACTORING_ID);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(variabilityMechanismEClass, VariabilityMechanism.class,
				"VariabilityMechanism", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVariabilityMechanism_Name(),
				theEcorePackage.getEString(), "name", null, 0, 1,
				VariabilityMechanism.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getVariabilityMechanism_RefactoringID(),
				theEcorePackage.getEString(), "refactoringID", null, 0, 1,
				VariabilityMechanism.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
