...
public interface RealizationPackage extends EPackage {
	 ...
	 * @generated
	 */
	RealizationPackage eINSTANCE = org.splevo.vpm.realization.impl.RealizationPackageImpl
			.init();
	...
	/**
	 * The number of operations of the '<em>Variability Mechanism</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute VARIABILITY_MECHANISM__NAME = eINSTANCE
				.getVariabilityMechanism_Name();
		 ...
		 * @generated
		 */
		EAttribute VARIABILITY_MECHANISM__REFACTORING_ID = eINSTANCE
				.getVariabilityMechanism_RefactoringID();
