 ...
 *   <li>{@link org.splevo.vpm.software.impl.SourceLocationImpl#getEndLine <em>End Line</em>}</li>
...
public class SourceLocationImpl extends EObjectImpl implements SourceLocation {
    ...
    public void setFilePath(String newFilePath) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwarePackage.SOURCE_LOCATION__FILE_PATH,
    ...
    public void setStartLine(int newStartLine) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwarePackage.SOURCE_LOCATION__START_LINE,
    ...
    public void setStartPosition(int newStartPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwarePackage.SOURCE_LOCATION__START_POSITION,
    ...
    public void setEndLine(int newEndLine) {
        ...
        endLine = newEndLine;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwarePackage.SOURCE_LOCATION__END_LINE,
                    oldEndLine, endLine));
    }
    ...
    public void setEndPosition(int newEndPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwarePackage.SOURCE_LOCATION__END_POSITION,
