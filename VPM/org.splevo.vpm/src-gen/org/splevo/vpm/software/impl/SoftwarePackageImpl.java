...
public class SoftwarePackageImpl extends EPackageImpl implements SoftwarePackage {
    ...
    public void createPackageContents() {
        ...
        createEOperation(softwareElementEClass, SOFTWARE_ELEMENT___GET_SOURCE_LOCATION);
        createEOperation(softwareElementEClass, SOFTWARE_ELEMENT___GET_WRAPPED_ELEMENT);
        createEOperation(softwareElementEClass, SOFTWARE_ELEMENT___GET_QUALIFIED_NAME);
    ...
    public void initializePackageContents() {
        ...
        initEOperation(getSoftwareElement__GetLabel(), ecorePackage.getEString(), "getLabel", 0, 1, IS_UNIQUE,
                IS_ORDERED);

        initEOperation(getSoftwareElement__GetName(), ecorePackage.getEString(), "getName", 0, 1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getSoftwareElement__GetSourceLocation(), this.getSourceLocation(), "getSourceLocation", 0, 1,
                IS_UNIQUE, IS_ORDERED);

        initEOperation(getSoftwareElement__GetWrappedElement(), theEcorePackage.getEObject(), "getWrappedElement", 0,
                1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getSoftwareElement__GetQualifiedName(), ecorePackage.getEString(), "getQualifiedName", 1, 1,
                IS_UNIQUE, IS_ORDERED);
