...
public class SoftwarePackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		addEOperation(softwareElementEClass, ecorePackage.getEString(),
				"getLabel", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(softwareElementEClass, ecorePackage.getEString(),
				"getName", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(softwareElementEClass, this.getSourceLocation(),
				"getSourceLocation", 0, 1, IS_UNIQUE, IS_ORDERED);
