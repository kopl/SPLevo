...
public class SoftwarePackageImpl extends EPackageImpl implements
	...
	public EAttribute getSourceLocation_FilePath() {
		return (EAttribute) sourceLocationEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(softwareElementEClass, SOFTWARE_ELEMENT___GET_LABEL);
		createEOperation(softwareElementEClass, SOFTWARE_ELEMENT___GET_NAME);
		createEOperation(softwareElementEClass,
				SOFTWARE_ELEMENT___GET_SOURCE_LOCATION);
		createEOperation(softwareElementEClass,
				SOFTWARE_ELEMENT___GET_WRAPPED_ELEMENT);
	...
	public void initializePackageContents() {
		...
		javaSoftwareElementEClass.getESuperTypes().add(
				this.getSoftwareElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(softwareElementEClass, SoftwareElement.class,
				"SoftwareElement", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEOperation(getSoftwareElement__GetLabel(),
				ecorePackage.getEString(), "getLabel", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEOperation(getSoftwareElement__GetName(),
				ecorePackage.getEString(), "getName", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEOperation(getSoftwareElement__GetSourceLocation(),
				this.getSourceLocation(), "getSourceLocation", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEOperation(getSoftwareElement__GetWrappedElement(),
				theEcorePackage.getEObject(), "getWrappedElement", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		initEClass(javaSoftwareElementEClass, JavaSoftwareElement.class,
				"JavaSoftwareElement", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(sourceLocationEClass, SourceLocation.class,
				"SourceLocation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSourceLocation_FilePath(),
				theEcorePackage.getEString(), "filePath", null, 0, 1,
				SourceLocation.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSourceLocation_StartLine(),
				theEcorePackage.getEInt(), "startLine", null, 0, 1,
				SourceLocation.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSourceLocation_StartPosition(),
				theEcorePackage.getEInt(), "startPosition", null, 0, 1,
				SourceLocation.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSourceLocation_EndPosition(),
				theEcorePackage.getEInt(), "endPosition", null, 0, 1,
				SourceLocation.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
