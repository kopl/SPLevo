...
public interface variabilityPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int VARIATION_POINT_MODEL_FEATURE_COUNT = 3;
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference VARIATION_POINT_MODEL__LEADING_MODEL = eINSTANCE
				.getVariationPointModel_LeadingModel();
		 ...
		 * @generated
		 */
		EReference VARIATION_POINT_MODEL__INTEGRATION_MODEL = eINSTANCE
				.getVariationPointModel_IntegrationModel();
