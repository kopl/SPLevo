...
public interface variabilityPackage extends EPackage {
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference VARIATION_POINT__LOCATION = eINSTANCE
				.getVariationPoint_Location();
		 ...
		 * @generated
		 */
		EAttribute VARIATION_POINT__VARIABILITY_TYPE = eINSTANCE
				.getVariationPoint_VariabilityType();
		 ...
		 * @generated
		 */
		EAttribute VARIATION_POINT__BINDING_TIME = eINSTANCE
				.getVariationPoint_BindingTime();
		 ...
		 * @generated
		 */
		EAttribute VARIATION_POINT__EXTENSIBILITY = eINSTANCE
				.getVariationPoint_Extensibility();
		 ...
		 * @generated
		 */
		EReference VARIATION_POINT__VARIABILITY_MECHANISM = eINSTANCE
				.getVariationPoint_VariabilityMechanism();
		 ...
		 * @generated
		 */
		EAttribute VARIATION_POINT__REFACTORED = eINSTANCE
				.getVariationPoint_Refactored();
		 ...
		 * @generated
		 */
		EReference VARIANT__IMPLEMENTING_ELEMENTS = eINSTANCE
				.getVariant_ImplementingElements();
		 ...
		 * @generated
		 */
		EOperation VARIATION_POINT_GROUP___IS_REFACTORED = eINSTANCE
				.getVariationPointGroup__IsRefactored();
		 ...
		 * @generated
		 */
		EClass CUSTOMIZABLE_DESCRIPTION_HAVING = eINSTANCE
				.getCustomizableDescriptionHaving();
		 ...
		 * @generated
		 */
		EAttribute CUSTOMIZABLE_NAME_HAVING__NAME = eINSTANCE
				.getCustomizableNameHaving_Name();
