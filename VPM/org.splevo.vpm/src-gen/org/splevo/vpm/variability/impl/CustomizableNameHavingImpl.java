 ...
 * @generated
 */
public abstract class CustomizableNameHavingImpl extends
		MinimalEObjectImpl.Container implements CustomizableNameHaving {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.CUSTOMIZABLE_NAME_HAVING__NAME, oldName,
					name));
	}
