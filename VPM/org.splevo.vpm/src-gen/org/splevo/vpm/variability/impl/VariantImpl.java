...
public class VariantImpl extends EObjectImpl implements Variant {
    ...
    public EList<SoftwareElement> getSoftwareEntities() {
        if (softwareEntities == null) {
            softwareEntities = new EObjectResolvingEList<SoftwareElement>(SoftwareElement.class, this,
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case variabilityPackage.VARIANT__SOFTWARE_ENTITIES:
            ...
            getSoftwareEntities().addAll((Collection<? extends SoftwareElement>) newValue);
            return;
        case variabilityPackage.VARIANT__LEADING:
