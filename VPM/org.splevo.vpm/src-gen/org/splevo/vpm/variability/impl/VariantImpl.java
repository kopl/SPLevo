 ...
 * @generated
 */
public class VariantImpl extends MinimalEObjectImpl.Container implements
		Variant {
	/**
	...
	public EList<SoftwareElement> getImplementingElements() {
		if (implementingElements == null) {
			implementingElements = new EObjectResolvingEList<SoftwareElement>(
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIANT__ID, oldId, id));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case variabilityPackage.VARIANT__IMPLEMENTING_ELEMENTS:
			...
			getImplementingElements().addAll(
	...
	public boolean eIsSet(int featureID) {
		...
		case variabilityPackage.VARIANT__IMPLEMENTING_ELEMENTS:
			return implementingElements != null
					&& !implementingElements.isEmpty();
		case variabilityPackage.VARIANT__ID:
