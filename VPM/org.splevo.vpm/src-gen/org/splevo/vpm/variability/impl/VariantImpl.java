...
public class VariantImpl extends EObjectImpl implements Variant {
	 ...
	 * @ordered
	 */
	protected EList<SoftwareElement> softwareEntities;
			...
			if (childFeature != oldChildFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							variabilityPackage.VARIANT__CHILD_FEATURE,
	...
	public void setChildFeature(Feature newChildFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIANT__CHILD_FEATURE, oldChildFeature,
					childFeature));
	}
	 ...
	 * @generated
	 */
	public EList<SoftwareElement> getSoftwareEntities() {
		if (softwareEntities == null) {
			softwareEntities = new EObjectResolvingEList<SoftwareElement>(
					SoftwareElement.class, this,
					variabilityPackage.VARIANT__SOFTWARE_ENTITIES);
		}
	...
	public void setLeading(Boolean newLeading) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIANT__LEADING, oldLeading, leading));
	}
	...
	public void setVariantId(String newVariantId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIANT__VARIANT_ID, oldVariantId,
					variantId));
	}
	...
	public NotificationChain basicSetVariationPoint(
		...
		msgs = eBasicSetContainer((InternalEObject) newVariationPoint,
				variabilityPackage.VARIANT__VARIATION_POINT, msgs);
		return msgs;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case variabilityPackage.VARIANT__SOFTWARE_ENTITIES:
			...
			getSoftwareEntities().addAll(
					(Collection<? extends SoftwareElement>) newValue);
			return;
		case variabilityPackage.VARIANT__LEADING:
	...
	public boolean eIsSet(int featureID) {
		...
		case variabilityPackage.VARIANT__LEADING:
			return LEADING_EDEFAULT == null ? leading != null
					: !LEADING_EDEFAULT.equals(leading);
		case variabilityPackage.VARIANT__VARIANT_ID:
			return VARIANT_ID_EDEFAULT == null ? variantId != null
					: !VARIANT_ID_EDEFAULT.equals(variantId);
		case variabilityPackage.VARIANT__VARIATION_POINT:
