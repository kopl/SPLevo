 ...
 * @generated
 */
public class VariationPointGroupImpl extends CustomizableNameHavingImpl
		implements VariationPointGroup {
	/**
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT_GROUP__DESCRIPTION,
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case variabilityPackage.VARIATION_POINT_GROUP___IS_REFACTORED:
			return isRefactored();
		}
