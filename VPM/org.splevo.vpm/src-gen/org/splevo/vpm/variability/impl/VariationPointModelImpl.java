 ...
 * @generated
 */
public class VariationPointModelImpl extends MinimalEObjectImpl.Container
		implements VariationPointModel {
	/**
	...
	public EList<SoftwareElement> getSoftwareElements() {
		if (softwareElements == null) {
			softwareElements = new EObjectContainmentEList<SoftwareElement>(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case variabilityPackage.VARIATION_POINT_MODEL__VARIATION_POINT_GROUPS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getVariationPointGroups())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case variabilityPackage.VARIATION_POINT_MODEL__VARIATION_POINT_GROUPS:
			return ((InternalEList<?>) getVariationPointGroups()).basicRemove(
					otherEnd, msgs);
		case variabilityPackage.VARIATION_POINT_MODEL__SOFTWARE_ELEMENTS:
			return ((InternalEList<?>) getSoftwareElements()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case variabilityPackage.VARIATION_POINT_MODEL__VARIATION_POINT_GROUPS:
			...
			getVariationPointGroups().addAll(
					(Collection<? extends VariationPointGroup>) newValue);
			return;
		case variabilityPackage.VARIATION_POINT_MODEL__SOFTWARE_ELEMENTS:
			getSoftwareElements().clear();
			getSoftwareElements().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case variabilityPackage.VARIATION_POINT_MODEL__VARIATION_POINT_GROUPS:
			return variationPointGroups != null
					&& !variationPointGroups.isEmpty();
		case variabilityPackage.VARIATION_POINT_MODEL__SOFTWARE_ELEMENTS:
