			...
			if (leadingModel != oldLeadingModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							variabilityPackage.VARIATION_POINT_MODEL__LEADING_MODEL,
							oldLeadingModel, leadingModel));
			}
		}
		return leadingModel;
	}
			...
			if (integrationModel != oldIntegrationModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							variabilityPackage.VARIATION_POINT_MODEL__INTEGRATION_MODEL,
							oldIntegrationModel, integrationModel));
			}
		}
