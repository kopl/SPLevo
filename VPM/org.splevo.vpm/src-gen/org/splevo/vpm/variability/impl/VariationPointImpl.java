 ...
 *   <li>{@link org.splevo.vpm.variability.impl.VariationPointImpl#isRefactored <em>Refactored</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VariationPointImpl extends IdentifierImpl implements
		VariationPoint {
	/**
	...
	/**
	 * The default value of the '{@link #isRefactored() <em>Refactored</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isRefactored()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isRefactored() <em>Refactored</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isRefactored()
	 * @generated
	 * @ordered
	 */
	protected boolean refactored = REFACTORED_EDEFAULT;
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__DESCRIPTION,
			...
			if (location != oldLocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							variabilityPackage.VARIATION_POINT__LOCATION,
	...
	public void setLocation(SoftwareElement newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__LOCATION, oldLocation,
					location));
	}
	...
	public void setVariabilityType(VariabilityType newVariabilityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__VARIABILITY_TYPE,
	...
	public void setBindingTime(BindingTime newBindingTime) {
		...
		bindingTime = newBindingTime == null ? BINDING_TIME_EDEFAULT
				: newBindingTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__BINDING_TIME,
	...
	public void setExtensibility(Extensible newExtensibility) {
		...
		extensibility = newExtensibility == null ? EXTENSIBILITY_EDEFAULT
				: newExtensibility;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__EXTENSIBILITY,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVariabilityMechanism(
			VariabilityMechanism newVariabilityMechanism, NotificationChain msgs) {
		VariabilityMechanism oldVariabilityMechanism = variabilityMechanism;
		variabilityMechanism = newVariabilityMechanism;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					variabilityPackage.VARIATION_POINT__VARIABILITY_MECHANISM,
					oldVariabilityMechanism, newVariabilityMechanism);
			if (msgs == null)
				msgs = notification;
			else
	 ...
	 * @generated
	 */
	public void setVariabilityMechanism(
			VariabilityMechanism newVariabilityMechanism) {
		if (newVariabilityMechanism != variabilityMechanism) {
			NotificationChain msgs = null;
			if (variabilityMechanism != null)
				msgs = ((InternalEObject) variabilityMechanism)
						.eInverseRemove(
								this,
			...
			if (newVariabilityMechanism != null)
				msgs = ((InternalEObject) newVariabilityMechanism)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- variabilityPackage.VARIATION_POINT__VARIABILITY_MECHANISM,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__VARIABILITY_MECHANISM,
					newVariabilityMechanism, newVariabilityMechanism));
	}
	 ...
	 * @generated
	 */
	public void setRefactored(boolean newRefactored) {
		boolean oldRefactored = refactored;
		refactored = newRefactored;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					variabilityPackage.VARIATION_POINT__REFACTORED,
	...
	public boolean allValidatorsSucceed(DiagnosticChain chain, Map<?, ?> context) {
		...
		try {
			validators = ExtensionHelper.getAllRegisteredExtensions(
					"org.spelvo.vpm.vpmvalidators", VPMValidator.class);
			...
			if (!validationResult.isValid()) {
				if (chain != null) {
					chain.add(new BasicDiagnostic(
							Diagnostic.ERROR,
							variabilityValidator.DIAGNOSTIC_SOURCE,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case variabilityPackage.VARIATION_POINT__VARIABILITY_MECHANISM:
			...
			return;
		case variabilityPackage.VARIATION_POINT__REFACTORED:
			setRefactored((Boolean) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case variabilityPackage.VARIATION_POINT__VARIABILITY_MECHANISM:
			...
			return;
		case variabilityPackage.VARIATION_POINT__REFACTORED:
			setRefactored(REFACTORED_EDEFAULT);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case variabilityPackage.VARIATION_POINT__REFACTORED:
			return refactored != REFACTORED_EDEFAULT;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case variabilityPackage.VARIATION_POINT___ALL_VALIDATORS_SUCCEED__DIAGNOSTICCHAIN_MAP:
			return allValidatorsSucceed((DiagnosticChain) arguments.get(0),
					(Map<?, ?>) arguments.get(1));
		}
