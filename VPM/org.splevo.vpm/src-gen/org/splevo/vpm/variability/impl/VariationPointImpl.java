...
public class VariationPointImpl extends EObjectImpl implements VariationPoint {
     ...
     * @ordered
     */
    protected SoftwareElement enclosingSoftwareEntity;
     ...
     * @generated
     */
    public SoftwareElement getEnclosingSoftwareEntity() {
        if (enclosingSoftwareEntity != null && enclosingSoftwareEntity.eIsProxy()) {
            InternalEObject oldEnclosingSoftwareEntity = (InternalEObject) enclosingSoftwareEntity;
            enclosingSoftwareEntity = (SoftwareElement) eResolveProxy(oldEnclosingSoftwareEntity);
            if (enclosingSoftwareEntity != oldEnclosingSoftwareEntity) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            variabilityPackage.VARIATION_POINT__ENCLOSING_SOFTWARE_ENTITY, oldEnclosingSoftwareEntity,
                            enclosingSoftwareEntity));
            }
        }
     ...
     * @generated
     */
    public SoftwareElement basicGetEnclosingSoftwareEntity() {
        return enclosingSoftwareEntity;
    }
     ...
     * @generated
     */
    public void setEnclosingSoftwareEntity(SoftwareElement newEnclosingSoftwareEntity) {
        SoftwareElement oldEnclosingSoftwareEntity = enclosingSoftwareEntity;
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case variabilityPackage.VARIATION_POINT__VARIANTS:
            ...
            return;
        case variabilityPackage.VARIATION_POINT__ENCLOSING_SOFTWARE_ENTITY:
            setEnclosingSoftwareEntity((SoftwareElement) newValue);
            return;
        case variabilityPackage.VARIATION_POINT__GROUP:
    ...
    public void eUnset(int featureID) {
        ...
        case variabilityPackage.VARIATION_POINT__VARIANTS:
            ...
            return;
        case variabilityPackage.VARIATION_POINT__ENCLOSING_SOFTWARE_ENTITY:
            setEnclosingSoftwareEntity((SoftwareElement) null);
            return;
        case variabilityPackage.VARIATION_POINT__GROUP:
