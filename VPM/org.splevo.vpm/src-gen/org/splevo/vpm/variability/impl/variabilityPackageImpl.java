...
public class variabilityPackageImpl extends EPackageImpl implements variabilityPackage {
    ...
    public EAttribute getVariationPoint_Refactored() {
        return (EAttribute) variationPointEClass.getEStructuralFeatures().get(7);
    }
    ...
    public void createPackageContents() {
        ...
        createEOperation(variationPointEClass, VARIATION_POINT___ALL_VALIDATORS_SUCCEED__DIAGNOSTICCHAIN_MAP);
        ...
        createEOperation(variationPointGroupEClass, VARIATION_POINT_GROUP___IS_REFACTORED);
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getVariationPoint_Refactored(), theEcorePackage.getEBoolean(), "refactored", null, 1, 1,
                VariationPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        EOperation op = initEOperation(getVariationPoint__AllValidatorsSucceed__DiagnosticChain_Map(),
                ecorePackage.getEBoolean(), "allValidatorsSucceed", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        initEOperation(getVariationPointGroup__IsRefactored(), theEcorePackage.getEBoolean(), "isRefactored", 1, 1,
