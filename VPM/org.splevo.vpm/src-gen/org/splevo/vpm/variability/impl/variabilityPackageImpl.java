...
public class variabilityPackageImpl extends EPackageImpl implements variabilityPackage {
    ...
    public void initializePackageContents() {
        ...
        initEReference(getVariationPoint_EnclosingSoftwareEntity(), theJavaPackage.getASTNode(), null,
        ...
        initEReference(getVariant_SoftwareEntities(), theJavaPackage.getASTNode(), null, "softwareEntities", null, 1,
                -1, Variant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
