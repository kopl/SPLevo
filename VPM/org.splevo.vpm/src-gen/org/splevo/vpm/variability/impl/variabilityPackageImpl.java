...
public class variabilityPackageImpl extends EPackageImpl implements
	...
	public void createPackageContents() {
		...
		createEReference(variationPointModelEClass,
				VARIATION_POINT_MODEL__LEADING_MODEL);
		createEReference(variationPointModelEClass,
				VARIATION_POINT_MODEL__INTEGRATION_MODEL);
		createEReference(variationPointModelEClass,
	...
	public void initializePackageContents() {
		...
		initEReference(getVariationPoint_EnclosingSoftwareEntity(),
				theJavaPackage.getASTNode(), null, "enclosingSoftwareEntity",
		...
		initEReference(getVariant_SoftwareEntities(),
				theJavaPackage.getASTNode(), null, "softwareEntities", null, 1,
		...
		initEClass(variationPointModelEClass, VariationPointModel.class,
				...
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVariationPointModel_LeadingModel(),
				theJavaapplicationPackage.getJavaApplication(), null,
				"leadingModel", null, 1, 1, VariationPointModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getVariationPointModel_IntegrationModel(),
				theJavaapplicationPackage.getJavaApplication(), null,
				"integrationModel", null, 1, 1, VariationPointModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
