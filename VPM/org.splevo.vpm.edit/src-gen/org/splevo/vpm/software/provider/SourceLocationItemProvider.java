 ...
 * @generated
 */
public class SourceLocationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addFilePathPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_SourceLocation_filePath_feature",
                        "_UI_SourceLocation_type"), SoftwarePackage.Literals.SOURCE_LOCATION__FILE_PATH, true, false,
    ...
    protected void addStartLinePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_SourceLocation_startLine_feature",
                        "_UI_SourceLocation_type"), SoftwarePackage.Literals.SOURCE_LOCATION__START_LINE, true, false,
    ...
    protected void addStartPositionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_SourceLocation_startPosition_feature",
                        "_UI_SourceLocation_type"), SoftwarePackage.Literals.SOURCE_LOCATION__START_POSITION, true,
    ...
    protected void addEndLinePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_SourceLocation_endLine_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_SourceLocation_endLine_feature",
                        "_UI_SourceLocation_type"), SoftwarePackage.Literals.SOURCE_LOCATION__END_LINE, true, false,
                false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addEndPositionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_SourceLocation_endPosition_feature",
                        "_UI_SourceLocation_type"), SoftwarePackage.Literals.SOURCE_LOCATION__END_POSITION, true,
                false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceLocation"));
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        case SoftwarePackage.SOURCE_LOCATION__END_LINE:
