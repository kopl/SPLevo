 ...
 * @generated
 */
public class VariationPointModelItemProvider extends ItemProviderAdapter
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_VariationPointModel_softwareElements_feature",
								"_UI_VariationPointModel_type"),
						variabilityPackage.Literals.VARIATION_POINT_MODEL__SOFTWARE_ELEMENTS,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(variabilityPackage.Literals.VARIATION_POINT_MODEL__VARIATION_POINT_GROUPS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/VariationPointModel"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						...
						variabilityFactory.eINSTANCE
								.createVariationPointGroup()));
	}
