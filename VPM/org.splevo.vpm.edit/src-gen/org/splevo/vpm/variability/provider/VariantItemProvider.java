 ...
 * @generated
 */
public class VariantItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Variant_childFeature_feature",
								"_UI_Variant_type"),
	...
	protected void addSoftwareEntitiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Variant_softwareEntities_feature",
						"_UI_Variant_type"),
				variabilityPackage.Literals.VARIANT__SOFTWARE_ENTITIES, true,
	...
	protected void addLeadingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Variant_leading_feature", "_UI_Variant_type"),
				variabilityPackage.Literals.VARIANT__LEADING, true, false,
	...
	protected void addVariantIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Variant_variantId_feature", "_UI_Variant_type"),
				variabilityPackage.Literals.VARIANT__VARIANT_ID, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
			...
			if (((Variant) object).getLeading() == Boolean.FALSE) {
				return overlayImage(
						...
						getResourceLocator().getImage(
								"full/obj16/VariantIntegration"));
			}
		}
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Variant"));
	}
