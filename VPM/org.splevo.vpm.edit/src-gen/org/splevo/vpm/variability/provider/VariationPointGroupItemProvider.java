 ...
 * @generated
 */
public class VariationPointGroupItemProvider extends ItemProviderAdapter
	...
	protected void addGroupIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_VariationPointGroup_groupId_feature",
						"_UI_VariationPointGroup_type"),
	...
	protected void addFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_VariationPointGroup_feature_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VariationPointGroup_feature_feature",
						"_UI_VariationPointGroup_type"),
				variabilityPackage.Literals.VARIATION_POINT_GROUP__FEATURE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(variabilityPackage.Literals.VARIATION_POINT_GROUP__VARIATION_POINTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/VariationPointGroup"));
	}
