...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>realization</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RealizationExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(RealizationPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.realization"));
				VariabilityMechanism root = RealizationFactory.eINSTANCE
