...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Import Insert</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.ImportInsertImpl#getImportLeft <em>
 * Import Left</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ImportInsertImpl extends ImportDeclarationChangeImpl implements ImportInsert {
            ...
            if (importLeft != oldImportLeft) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Java2KDMDiffPackage.IMPORT_INSERT__IMPORT_LEFT, oldImportLeft, importLeft));
            }
        }
        return importLeft;
    }
    ...
    public void setImportLeft(ImportDeclaration newImportLeft) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.IMPORT_INSERT__IMPORT_LEFT,
                    oldImportLeft, importLeft));
    }
    ...
    /**
     * <!-- begin-user-doc --> The difference kind of an import insert is always
