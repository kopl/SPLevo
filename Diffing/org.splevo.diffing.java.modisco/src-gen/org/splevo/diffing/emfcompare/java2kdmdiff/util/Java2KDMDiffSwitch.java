...
public class Java2KDMDiffSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case Java2KDMDiffPackage.JAVA2_KDM_DIFF_EXTENSION: {
            ...
            if (result == null)
                result = caseAbstractDiffExtension(java2KDMDiffExtension);
            if (result == null)
                result = caseDiffElement(java2KDMDiffExtension);
            if (result == null)
        ...
        case Java2KDMDiffPackage.STATEMENT_CHANGE: {
            ...
            if (result == null)
                result = caseAbstractDiffExtension(statementChange);
            if (result == null)
                result = caseDiffElement(statementChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.IMPORT_DECLARATION_CHANGE: {
            ...
            if (result == null)
                result = caseJava2KDMDiffExtension(importDeclarationChange);
            if (result == null)
                result = caseAbstractDiffExtension(importDeclarationChange);
            if (result == null)
                result = caseDiffElement(importDeclarationChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.IMPORT_INSERT: {
            ...
            if (result == null)
                result = caseImportDeclarationChange(importInsert);
            if (result == null)
                result = caseJava2KDMDiffExtension(importInsert);
            if (result == null)
                result = caseAbstractDiffExtension(importInsert);
            if (result == null)
                result = caseDiffElement(importInsert);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.IMPORT_DELETE: {
            ...
            if (result == null)
                result = caseImportDeclarationChange(importDelete);
            if (result == null)
                result = caseJava2KDMDiffExtension(importDelete);
            if (result == null)
                result = caseAbstractDiffExtension(importDelete);
            if (result == null)
                result = caseDiffElement(importDelete);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.CLASS_CHANGE: {
            ...
            if (result == null)
                result = caseAbstractDiffExtension(classChange);
            if (result == null)
                result = caseDiffElement(classChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_INSERT: {
            ...
            if (result == null)
                result = caseClassChange(implementsInterfaceInsert);
            if (result == null)
                result = caseJava2KDMDiffExtension(implementsInterfaceInsert);
            if (result == null)
                result = caseAbstractDiffExtension(implementsInterfaceInsert);
            if (result == null)
                result = caseDiffElement(implementsInterfaceInsert);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE: {
            ...
            if (result == null)
                result = caseClassChange(implementsInterfaceDelete);
            if (result == null)
                result = caseJava2KDMDiffExtension(implementsInterfaceDelete);
            if (result == null)
                result = caseAbstractDiffExtension(implementsInterfaceDelete);
            if (result == null)
                result = caseDiffElement(implementsInterfaceDelete);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.FIELD_CHANGE: {
            ...
            if (result == null)
                result = caseAbstractDiffExtension(fieldChange);
            if (result == null)
                result = caseDiffElement(fieldChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.FIELD_INSERT: {
            ...
            if (result == null)
                result = caseFieldChange(fieldInsert);
            if (result == null)
                result = caseJava2KDMDiffExtension(fieldInsert);
            if (result == null)
                result = caseAbstractDiffExtension(fieldInsert);
            if (result == null)
                result = caseDiffElement(fieldInsert);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.FIELD_DELETE: {
            ...
            if (result == null)
                result = caseFieldChange(fieldDelete);
            if (result == null)
                result = caseJava2KDMDiffExtension(fieldDelete);
            if (result == null)
                result = caseAbstractDiffExtension(fieldDelete);
            if (result == null)
                result = caseDiffElement(fieldDelete);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.CLASS_INSERT: {
            ...
            if (result == null)
                result = caseClassChange(classInsert);
            if (result == null)
                result = caseJava2KDMDiffExtension(classInsert);
            if (result == null)
                result = caseAbstractDiffExtension(classInsert);
            if (result == null)
                result = caseDiffElement(classInsert);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.CLASS_DELETE: {
            ...
            if (result == null)
                result = caseClassChange(classDelete);
            if (result == null)
                result = caseJava2KDMDiffExtension(classDelete);
            if (result == null)
                result = caseAbstractDiffExtension(classDelete);
            if (result == null)
                result = caseDiffElement(classDelete);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.PACKAGE_CHANGE: {
            ...
            if (result == null)
                result = caseAbstractDiffExtension(packageChange);
            if (result == null)
                result = caseDiffElement(packageChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.PACKAGE_INSERT: {
            ...
            if (result == null)
                result = casePackageChange(packageInsert);
            if (result == null)
                result = caseJava2KDMDiffExtension(packageInsert);
            if (result == null)
                result = caseAbstractDiffExtension(packageInsert);
            if (result == null)
                result = caseDiffElement(packageInsert);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.PACKAGE_DELETE: {
            ...
            if (result == null)
                result = casePackageChange(packageDelete);
            if (result == null)
                result = caseJava2KDMDiffExtension(packageDelete);
            if (result == null)
                result = caseAbstractDiffExtension(packageDelete);
            if (result == null)
                result = caseDiffElement(packageDelete);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.METHOD_CHANGE: {
            ...
            if (result == null)
                result = caseAbstractDiffExtension(methodChange);
            if (result == null)
                result = caseDiffElement(methodChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.METHOD_INSERT: {
            ...
            if (result == null)
                result = caseMethodChange(methodInsert);
            if (result == null)
                result = caseJava2KDMDiffExtension(methodInsert);
            if (result == null)
                result = caseAbstractDiffExtension(methodInsert);
            if (result == null)
                result = caseDiffElement(methodInsert);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.METHOD_DELETE: {
            ...
            if (result == null)
                result = caseMethodChange(methodDelete);
            if (result == null)
                result = caseJava2KDMDiffExtension(methodDelete);
            if (result == null)
                result = caseAbstractDiffExtension(methodDelete);
            if (result == null)
                result = caseDiffElement(methodDelete);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.STATEMENT_INSERT: {
            ...
            if (result == null)
                result = caseStatementChange(statementInsert);
            if (result == null)
                result = caseJava2KDMDiffExtension(statementInsert);
            if (result == null)
                result = caseAbstractDiffExtension(statementInsert);
            if (result == null)
                result = caseDiffElement(statementInsert);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.STATEMENT_DELETE: {
            ...
            if (result == null)
                result = caseStatementChange(statementDelete);
            if (result == null)
                result = caseJava2KDMDiffExtension(statementDelete);
            if (result == null)
                result = caseAbstractDiffExtension(statementDelete);
            if (result == null)
                result = caseDiffElement(statementDelete);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.FIELD_DECLARATION_CHANGE: {
            ...
            if (result == null)
                result = caseFieldChange(fieldDeclarationChange);
            if (result == null)
                result = caseJava2KDMDiffExtension(fieldDeclarationChange);
            if (result == null)
                result = caseAbstractDiffExtension(fieldDeclarationChange);
            if (result == null)
                result = caseDiffElement(fieldDeclarationChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.ENUM_CHANGE: {
            ...
            if (result == null)
                result = caseAbstractDiffExtension(enumChange);
            if (result == null)
                result = caseDiffElement(enumChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Java2KDMDiffPackage.ENUM_DECLARATION_CHANGE: {
            ...
            if (result == null)
                result = caseEnumChange(enumDeclarationChange);
            if (result == null)
                result = caseJava2KDMDiffExtension(enumDeclarationChange);
            if (result == null)
                result = caseAbstractDiffExtension(enumDeclarationChange);
            if (result == null)
                result = caseDiffElement(enumDeclarationChange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
     ...
     * <em>Import Declaration Change</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Import Declaration Change</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Implements Interface Insert</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Implements Interface Insert</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Implements Interface Delete</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Implements Interface Delete</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Field Declaration Change</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Field Declaration Change</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Enum Declaration Change</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Enum Declaration Change</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Abstract Diff Extension</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
