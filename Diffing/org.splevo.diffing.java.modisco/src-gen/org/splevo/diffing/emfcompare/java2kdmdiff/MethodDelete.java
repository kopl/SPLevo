...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Method Delete</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.MethodDelete#getMethodRight <em>Method
 * Right</em>}</li>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.MethodDelete#getLeftContainer <em>Left
 * Container</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface MethodDelete extends MethodChange {
    /**
     * Returns the value of the '<em><b>Method Right</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Method Right</em>' reference isn't clear, there really should be
     ...
     * <em>Method Right</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Method Right</em>' reference.
     * @see #getMethodRight()
     * @generated
     */
     ...
     * longer contains the method. (according to emf compares "leftParent" terminology) <!--
     * end-model-doc -->
     * 
     * @return the value of the '<em>Left Container</em>' reference.
     * @see #setLeftContainer(ASTNode)
     * @see org.splevo.diffing.emfcompare.java2kdmdiff.Java2KDMDiffPackage#getMethodDelete_LeftContainer()
     * @model
     * @generated
     */
