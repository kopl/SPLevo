...
public class DiffModelPostProcessor extends DiffSwitch<Boolean>{
	 ...
	 * @param subDiffElements The sub diff elements to check.
	 * @param filteredElements The list of elements to filter.
	 */
	...
	public Boolean caseDiffGroup(DiffGroup diffGroup) {
		...
		if(	diffGroup.getRightParent() instanceof Statement){
			if(!(diffGroup.getRightParent() instanceof Block)){
				...
				statementChange.setStatementLeft((Statement) matchManager.getMatchedEObject(diffGroup.getRightParent()));
