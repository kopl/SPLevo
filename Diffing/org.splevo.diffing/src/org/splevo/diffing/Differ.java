...
/**
 * A differ encapsulating the technology specific diffing logic. It is capable
 * to select all software model files from a supplied base directory, performs
 * the diffing on it and returns a DiffModel, probably with technology specific
 * diff elements.
 */
public interface Differ {
	 ...
	 *             Identifying that the diffing could not be performed
	 *             successfully.
	 */
	DiffModel doDiff(URI leadingModelDirectory, URI integrationModelDirectory,
			Map<String, Object> diffingOptions) throws DiffingException;

	/**
	 * Get the identifier of the differ. This should be unique compared to all
	 * other loaded differs in the same instance.
	 * 
