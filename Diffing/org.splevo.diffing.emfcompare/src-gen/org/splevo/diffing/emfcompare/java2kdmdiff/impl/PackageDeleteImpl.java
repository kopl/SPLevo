 ...
 * <ul>
 *   <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.PackageDeleteImpl#getPackageRight <em>Package Right</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.PackageDeleteImpl#getLeftContainer <em>Left Container</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageDeleteImpl extends PackageChangeImpl implements PackageDelete {
    /**
        ...
        if (packageRight != null && packageRight.eIsProxy()) {
            ...
            if (packageRight != oldPackageRight) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java2KDMDiffPackage.PACKAGE_DELETE__PACKAGE_RIGHT, oldPackageRight, packageRight));
            }
        }
        return packageRight;
    }
    ...
    public void setPackageRight(org.eclipse.gmt.modisco.java.Package newPackageRight) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.PACKAGE_DELETE__PACKAGE_RIGHT, oldPackageRight, packageRight));
    }
    ...
    public org.eclipse.gmt.modisco.java.Package getLeftContainer() {
        if (leftContainer != null && leftContainer.eIsProxy()) {
            ...
            if (leftContainer != oldLeftContainer) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java2KDMDiffPackage.PACKAGE_DELETE__LEFT_CONTAINER, oldLeftContainer, leftContainer));
            }
        }
    ...
    public void setLeftContainer(org.eclipse.gmt.modisco.java.Package newLeftContainer) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.PACKAGE_DELETE__LEFT_CONTAINER, oldLeftContainer, leftContainer));
    }
    ...
    /**
     * <!-- begin-user-doc -->
     * The difference kind of a packge delete is always DifferenceKind.DELETION.
     * <!-- end-user-doc -->
     * {@inheritDoc}
     * @generated NOT
     */
