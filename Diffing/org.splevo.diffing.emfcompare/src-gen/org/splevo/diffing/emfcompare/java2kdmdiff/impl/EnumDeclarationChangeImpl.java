...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Enum Declaration Change</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.EnumDeclarationChangeImpl#getEnumLeft <em>Enum Left</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.EnumDeclarationChangeImpl#getEnumRight <em>Enum Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumDeclarationChangeImpl extends EnumChangeImpl implements EnumDeclarationChange {
        ...
        if (enumLeft != null && enumLeft.eIsProxy()) {
            ...
            if (enumLeft != oldEnumLeft) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java2KDMDiffPackage.ENUM_DECLARATION_CHANGE__ENUM_LEFT, oldEnumLeft, enumLeft));
            }
        }
        return enumLeft;
    }
    ...
    public void setEnumLeft(EnumDeclaration newEnumLeft) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.ENUM_DECLARATION_CHANGE__ENUM_LEFT, oldEnumLeft, enumLeft));
    }
    ...
    public EnumDeclaration getEnumRight() {
        if (enumRight != null && enumRight.eIsProxy()) {
            ...
            if (enumRight != oldEnumRight) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java2KDMDiffPackage.ENUM_DECLARATION_CHANGE__ENUM_RIGHT, oldEnumRight, enumRight));
            }
        }
        return enumRight;
    }
    ...
    public void setEnumRight(EnumDeclaration newEnumRight) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.ENUM_DECLARATION_CHANGE__ENUM_RIGHT, oldEnumRight, enumRight));
    }
