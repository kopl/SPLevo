...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Implements Interface Delete</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.ImplementsInterfaceDeleteImpl#getImplementedInterface <em>Implemented Interface</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.ImplementsInterfaceDeleteImpl#getChangedClass <em>Changed Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ImplementsInterfaceDeleteImpl extends ClassChangeImpl implements ImplementsInterfaceDelete {
    /**
     ...
     * @generated
     */
    protected ImplementsInterfaceDeleteImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return Java2KDMDiffPackage.Literals.IMPLEMENTS_INTERFACE_DELETE;
    }
        ...
        if (implementedInterface != null && implementedInterface.eIsProxy()) {
            ...
            if (implementedInterface != oldImplementedInterface) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__IMPLEMENTED_INTERFACE, oldImplementedInterface, implementedInterface));
            }
        }
    ...
    public void setImplementedInterface(InterfaceDeclaration newImplementedInterface) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__IMPLEMENTED_INTERFACE, oldImplementedInterface, implementedInterface));
    }
    ...
    public ClassDeclaration getChangedClass() {
        if (changedClass != null && changedClass.eIsProxy()) {
            ...
            if (changedClass != oldChangedClass) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__CHANGED_CLASS, oldChangedClass, changedClass));
            }
        }
        return changedClass;
    }
    ...
    public void setChangedClass(ClassDeclaration newChangedClass) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__CHANGED_CLASS, oldChangedClass, changedClass));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__IMPLEMENTED_INTERFACE:
                if (resolve) return getImplementedInterface();
                return basicGetImplementedInterface();
            case Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__CHANGED_CLASS:
    ...
    /**
     * <!-- begin-user-doc -->
     * The difference kind of an implements interface delete is always DifferenceKind.DELETION.
     * <!-- end-user-doc -->
     * {@inheritDoc}
     * @generated NOT
     */
