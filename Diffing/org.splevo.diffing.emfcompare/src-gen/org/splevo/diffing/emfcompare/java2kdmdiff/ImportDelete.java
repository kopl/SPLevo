...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Import Delete</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <!-- begin-model-doc --> An import that was deleted and is only present in the right model. <!--
 * end-model-doc -->
 * 
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.ImportDelete#getImportRight <em>Import
 * Right</em>}</li>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.ImportDelete#getLeftContainer <em>Left
 * Container</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface ImportDelete extends ImportDeclarationChange {
    /**
     * Returns the value of the '<em><b>Import Right</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Import Right</em>' reference isn't clear, there really should be
     ...
     * <em>Import Right</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Import Right</em>' reference.
     * @see #getImportRight()
     * @generated
     */
     ...
     * longer contains the import. (according to emf compares "leftParent" terminology) <!--
     * end-model-doc -->
     * 
