...
/**
 * This is the action bar contributor for the Java2KDMDiff model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class Java2KDMDiffActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    protected IAction showPropertiesViewAction = new Action(
            Java2KDMDiffEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
    ...
    protected IAction refreshViewerAction = new Action(
            Java2KDMDiffEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                Java2KDMDiffEditorPlugin.INSTANCE.getString("_UI_Java2KDMDiffEditor_menu"),
                "org.splevo.diffing.emfcompare.java2kdmdiffMenuID");
        ...
        createChildMenuManager = new MenuManager(
                Java2KDMDiffEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(
                Java2KDMDiffEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
