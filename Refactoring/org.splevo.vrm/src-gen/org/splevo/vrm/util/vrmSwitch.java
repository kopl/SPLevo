 ...
 * @generated
 */
public class vrmSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case vrmPackage.VARIABILITY_REALIZATION_CONFIGURATION: {
            VariabilityRealizationConfiguration variabilityRealizationConfiguration = (VariabilityRealizationConfiguration) theEObject;
            T result = caseVariabilityRealizationConfiguration(variabilityRealizationConfiguration);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Variability Realization Configuration</em>'. <!-- begin-user-doc --> This implementation
     * returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>Variability Realization Configuration</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
