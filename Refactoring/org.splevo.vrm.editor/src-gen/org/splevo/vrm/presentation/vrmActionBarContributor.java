...
/**
 * This is the action bar contributor for the vrm model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class vrmActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    protected IAction showPropertiesViewAction = new Action(
            VRMEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
    ...
    protected IAction refreshViewerAction = new Action(
            VRMEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
     ...
     * @generated
     */
    public vrmActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("vrm-settings"));
        toolBarManager.add(new Separator("vrm-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(VRMEditorPlugin.INSTANCE.getString("_UI_vrmEditor_menu"),
                "org.splevo.vrmMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(VRMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(VRMEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(VRMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(VRMEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
