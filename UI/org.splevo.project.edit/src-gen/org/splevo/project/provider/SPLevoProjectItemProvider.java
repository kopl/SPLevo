...
public class SPLevoProjectItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_name_feature",
						"_UI_SPLevoProject_type"),
				ProjectPackage.Literals.SP_LEVO_PROJECT__NAME, true, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_description_feature",
						"_UI_SPLevoProject_type"),
				ProjectPackage.Literals.SP_LEVO_PROJECT__DESCRIPTION, true,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_SPLevoProject_sourceModelPathLeading_feature",
								"_UI_SPLevoProject_type"),
	...
	protected void addSourceModelPathIntegrationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_SPLevoProject_sourceModelPathIntegration_feature",
								"_UI_SPLevoProject_type"),
	...
	protected void addLeadingProjectsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_leadingProjects_feature",
						"_UI_SPLevoProject_type"),
	...
	protected void addIntegrationProjectsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_integrationProjects_feature",
						"_UI_SPLevoProject_type"),
	...
	protected void addWorkspacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_workspace_feature",
						"_UI_SPLevoProject_type"),
				ProjectPackage.Literals.SP_LEVO_PROJECT__WORKSPACE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addVariantNameLeadingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_variantNameLeading_feature",
						"_UI_SPLevoProject_type"),
	...
	protected void addVariantNameIntegrationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_SPLevoProject_variantNameIntegration_feature",
								"_UI_SPLevoProject_type"),
	...
	protected void addDiffingModelPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_diffingModelPath_feature",
						"_UI_SPLevoProject_type"),
	...
	protected void addVpmModelPathsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_vpmModelPaths_feature",
						"_UI_SPLevoProject_type"),
				ProjectPackage.Literals.SP_LEVO_PROJECT__VPM_MODEL_PATHS, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addDiffingFilterRulesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_diffingFilterRules_feature",
						"_UI_SPLevoProject_type"),
	...
	protected void addExtractorIdsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_SPLevoProject_extractorIds_feature",
						"_UI_SPLevoProject_type"),
				ProjectPackage.Literals.SP_LEVO_PROJECT__EXTRACTOR_IDS, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/SPLevoProject"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SPLevoProject_type")
