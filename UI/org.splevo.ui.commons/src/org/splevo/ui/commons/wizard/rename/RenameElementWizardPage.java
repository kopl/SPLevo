...
/**
 * This WizardPage allows for the input of a new name of an element.
 */
public class RenameElementWizardPage extends WizardPage {
     ...
     */
    protected RenameElementWizardPage(final String elementTypeName, String oldName) {
