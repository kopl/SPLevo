...
public class ResourceManager extends SWTResourceManager {
    ...
    public static void disposeImages() {
        ...
        for (Iterator<Image> imageIterator = descriptorImageMap.values().iterator(); imageIterator.hasNext();) {
        ...
        for (Iterator<Image> imageIterator = urlImageMap.values().iterator(); imageIterator.hasNext();) {
            imageIterator.next().dispose();
        }
        urlImageMap.clear();
    }
