...
public class JavaEditorConnector {
     ...
     * 
     * @param locationNode
     *            The AST node identifying the location to open.
     * @param javaApplication
     *            The java application model to access the inventory.
     */
    ...
    public void openJavaEditor(final JavaNodeSourceRegion sourceRegion, final boolean openFileMultipleTimes) {
        ...
        if (sourceRegion.eContainer() instanceof Java2File) {
            ...
            Display.getDefault().asyncExec(new Runnable() {
                public void run() {
                    ...
                    int startPosition = sourceRegion.getStartPosition().intValue();
                    int endPosition = sourceRegion.getEndPosition().intValue();
