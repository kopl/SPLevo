...
public final class OpenSourceInEditorAction extends Action {
	...
	Logger logger = Logger.getLogger(OpenSourceInEditorAction.class);
	 ...
	 * refinement details.
	 * @param treeViewer The tree viewer to get the selection from.
	 */
	 ...
	 * This method takes checks the currently selected icon in the tree.
