...
import org.splevo.diffing.java.modisco.java2kdmdiff.ClassChange;
...
import org.splevo.diffing.java.modisco.java2kdmdiff.EnumChange;
import org.splevo.diffing.java.modisco.java2kdmdiff.EnumDeclarationChange;
import org.splevo.diffing.java.modisco.java2kdmdiff.FieldChange;
...
import org.splevo.diffing.java.modisco.java2kdmdiff.ImportDeclarationChange;
...
import org.splevo.diffing.java.modisco.java2kdmdiff.Java2KDMDiffExtension;
...
import org.splevo.diffing.java.modisco.java2kdmdiff.MethodChange;
import org.splevo.diffing.java.modisco.java2kdmdiff.MethodDelete;
import org.splevo.diffing.java.modisco.java2kdmdiff.MethodInsert;
import org.splevo.diffing.java.modisco.java2kdmdiff.PackageChange;
 ...
 * @generated
 */
public class Java2KDMDiffPackageImpl extends EPackageImpl implements
		Java2KDMDiffPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.splevo.diffing.java.modisco.java2kdmdiff.Java2KDMDiffPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static Java2KDMDiffPackage init() {
		if (isInited)
			return (Java2KDMDiffPackage) EPackage.Registry.INSTANCE
					.getEPackage(Java2KDMDiffPackage.eNS_URI);

		// Obtain or create and register package
		Java2KDMDiffPackageImpl theJava2KDMDiffPackage = (Java2KDMDiffPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof Java2KDMDiffPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new Java2KDMDiffPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(Java2KDMDiffPackage.eNS_URI,
				theJava2KDMDiffPackage);
	...
	public EReference getStatementChange_StatementRight() {
		return (EReference) statementChangeEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EReference getImplementsInterfaceInsert_ImplementedInterface() {
		return (EReference) implementsInterfaceInsertEClass
	...
	public EReference getImplementsInterfaceDelete_ImplementedInterface() {
		return (EReference) implementsInterfaceDeleteEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getStatementDelete_LeftContainer() {
		return (EReference) statementDeleteEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EReference getFieldDeclarationChange_FieldLeft() {
		return (EReference) fieldDeclarationChangeEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getEnumDeclarationChange_EnumLeft() {
		return (EReference) enumDeclarationChangeEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(statementChangeEClass,
				STATEMENT_CHANGE__STATEMENT_RIGHT);
		createEReference(statementChangeEClass,
				STATEMENT_CHANGE__STATEMENT_LEFT);
		...
		createEReference(implementsInterfaceInsertEClass,
				IMPLEMENTS_INTERFACE_INSERT__IMPLEMENTED_INTERFACE);
		createEReference(implementsInterfaceInsertEClass,
				IMPLEMENTS_INTERFACE_INSERT__CHANGED_CLASS);

		implementsInterfaceDeleteEClass = createEClass(IMPLEMENTS_INTERFACE_DELETE);
		createEReference(implementsInterfaceDeleteEClass,
				IMPLEMENTS_INTERFACE_DELETE__IMPLEMENTED_INTERFACE);
		createEReference(implementsInterfaceDeleteEClass,
				IMPLEMENTS_INTERFACE_DELETE__CHANGED_CLASS);
		...
		createEReference(statementDeleteEClass,
				STATEMENT_DELETE__LEFT_CONTAINER);

		fieldDeclarationChangeEClass = createEClass(FIELD_DECLARATION_CHANGE);
		createEReference(fieldDeclarationChangeEClass,
				FIELD_DECLARATION_CHANGE__FIELD_LEFT);
		createEReference(fieldDeclarationChangeEClass,
				FIELD_DECLARATION_CHANGE__FIELD_RIGHT);

		enumChangeEClass = createEClass(ENUM_CHANGE);

		enumDeclarationChangeEClass = createEClass(ENUM_DECLARATION_CHANGE);
		createEReference(enumDeclarationChangeEClass,
				ENUM_DECLARATION_CHANGE__ENUM_LEFT);
		createEReference(enumDeclarationChangeEClass,
				ENUM_DECLARATION_CHANGE__ENUM_RIGHT);
	}
	...
	public void initializePackageContents() {
		...
		DiffPackage theDiffPackage = (DiffPackage) EPackage.Registry.INSTANCE
		...
		java2KDMDiffExtensionEClass.getESuperTypes().add(
				theDiffPackage.getAbstractDiffExtension());
		java2KDMDiffExtensionEClass.getESuperTypes().add(
				theDiffPackage.getDiffElement());
		statementChangeEClass.getESuperTypes().add(
				this.getJava2KDMDiffExtension());
		importDeclarationChangeEClass.getESuperTypes().add(
				this.getJava2KDMDiffExtension());
		importInsertEClass.getESuperTypes().add(
				this.getImportDeclarationChange());
		importDeleteEClass.getESuperTypes().add(
				this.getImportDeclarationChange());
		classChangeEClass.getESuperTypes().add(this.getJava2KDMDiffExtension());
		implementsInterfaceInsertEClass.getESuperTypes().add(
				this.getClassChange());
		implementsInterfaceDeleteEClass.getESuperTypes().add(
				this.getClassChange());
		...
		fieldDeclarationChangeEClass.getESuperTypes()
				.add(this.getFieldChange());
		...
		initEClass(java2KDMDiffExtensionEClass, Java2KDMDiffExtension.class,
				"Java2KDMDiffExtension", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(statementChangeEClass, StatementChange.class,
				"StatementChange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStatementChange_StatementRight(),
				theJavaPackage.getStatement(), null, "statementRight", null, 0,
				1, StatementChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStatementChange_StatementLeft(),
				theJavaPackage.getStatement(), null, "statementLeft", null, 0,
				1, StatementChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(importDeclarationChangeEClass,
				ImportDeclarationChange.class, "ImportDeclarationChange",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(importInsertEClass, ImportInsert.class, "ImportInsert",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImportInsert_ImportLeft(),
				theJavaPackage.getImportDeclaration(), null, "importLeft",
				null, 0, 1, ImportInsert.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(importDeleteEClass, ImportDelete.class, "ImportDelete",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImportDelete_ImportRight(),
				theJavaPackage.getImportDeclaration(), null, "importRight",
				null, 0, 1, ImportDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getImportDelete_LeftContainer(),
				theJavaPackage.getCompilationUnit(), null, "leftContainer",
				null, 0, 1, ImportDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classChangeEClass, ClassChange.class, "ClassChange",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(implementsInterfaceInsertEClass,
				ImplementsInterfaceInsert.class, "ImplementsInterfaceInsert",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImplementsInterfaceInsert_ImplementedInterface(),
				theJavaPackage.getInterfaceDeclaration(), null,
				"implementedInterface", null, 1, 1,
				ImplementsInterfaceInsert.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getImplementsInterfaceInsert_ChangedClass(),
				theJavaPackage.getClassDeclaration(), null, "changedClass",
				null, 1, 1, ImplementsInterfaceInsert.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(implementsInterfaceDeleteEClass,
				ImplementsInterfaceDelete.class, "ImplementsInterfaceDelete",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImplementsInterfaceDelete_ImplementedInterface(),
				theJavaPackage.getInterfaceDeclaration(), null,
				"implementedInterface", null, 1, 1,
				ImplementsInterfaceDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getImplementsInterfaceDelete_ChangedClass(),
				theJavaPackage.getClassDeclaration(), null, "changedClass",
				null, 0, 1, ImplementsInterfaceDelete.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(fieldChangeEClass, FieldChange.class, "FieldChange",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(fieldInsertEClass, FieldInsert.class, "FieldInsert",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFieldInsert_FieldLeft(),
				theJavaPackage.getFieldDeclaration(), null, "fieldLeft", null,
				0, 1, FieldInsert.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(fieldDeleteEClass, FieldDelete.class, "FieldDelete",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFieldDelete_FieldRight(),
				theJavaPackage.getFieldDeclaration(), null, "fieldRight", null,
				0, 1, FieldDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFieldDelete_LeftContainer(),
				theJavaPackage.getASTNode(), null, "leftContainer", null, 0, 1,
				FieldDelete.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(classInsertEClass, ClassInsert.class, "ClassInsert",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClassInsert_ClassLeft(),
				theJavaPackage.getClassDeclaration(), null, "classLeft", null,
				1, 1, ClassInsert.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classDeleteEClass, ClassDelete.class, "ClassDelete",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClassDelete_ClassRight(),
				theJavaPackage.getClassDeclaration(), null, "classRight", null,
				1, 1, ClassDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClassDelete_LeftContainer(),
				theJavaPackage.getPackage(), null, "leftContainer", null, 0, 1,
				ClassDelete.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(packageChangeEClass, PackageChange.class, "PackageChange",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(packageInsertEClass, PackageInsert.class, "PackageInsert",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackageInsert_PackageLeft(),
				theJavaPackage.getPackage(), null, "packageLeft", null, 0, 1,
				PackageInsert.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(packageDeleteEClass, PackageDelete.class, "PackageDelete",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackageDelete_PackageRight(),
				theJavaPackage.getPackage(), null, "packageRight", null, 0, 1,
				PackageDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackageDelete_LeftContainer(),
				theJavaPackage.getPackage(), null, "leftContainer", null, 0, 1,
				PackageDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(methodChangeEClass, MethodChange.class, "MethodChange",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(methodInsertEClass, MethodInsert.class, "MethodInsert",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMethodInsert_MethodLeft(),
				theJavaPackage.getAbstractMethodDeclaration(), null,
				"methodLeft", null, 0, 1, MethodInsert.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(methodDeleteEClass, MethodDelete.class, "MethodDelete",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMethodDelete_MethodRight(),
				theJavaPackage.getAbstractMethodDeclaration(), null,
				"methodRight", null, 0, 1, MethodDelete.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethodDelete_LeftContainer(),
				theJavaPackage.getASTNode(), null, "leftContainer", null, 0, 1,
				MethodDelete.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(statementInsertEClass, StatementInsert.class,
				"StatementInsert", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(statementDeleteEClass, StatementDelete.class,
				"StatementDelete", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStatementDelete_LeftContainer(),
				theJavaPackage.getASTNode(), null, "leftContainer", null, 0, 1,
				StatementDelete.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(fieldDeclarationChangeEClass, FieldDeclarationChange.class,
				"FieldDeclarationChange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFieldDeclarationChange_FieldLeft(),
				theJavaPackage.getFieldDeclaration(), null, "fieldLeft", null,
				0, 1, FieldDeclarationChange.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFieldDeclarationChange_FieldRight(),
				theJavaPackage.getFieldDeclaration(), null, "fieldRight", null,
				0, 1, FieldDeclarationChange.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(enumChangeEClass, EnumChange.class, "EnumChange",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(enumDeclarationChangeEClass, EnumDeclarationChange.class,
				"EnumDeclarationChange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnumDeclarationChange_EnumLeft(),
				theJavaPackage.getEnumDeclaration(), null, "enumLeft", null, 0,
				1, EnumDeclarationChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEnumDeclarationChange_EnumRight(),
				theJavaPackage.getEnumDeclaration(), null, "enumRight", null,
				0, 1, EnumDeclarationChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getStatementChange_StatementRight(), source,
				new String[] { "name", "statementRight", "namespace", "" });
		addAnnotation(importDeclarationChangeEClass, source, new String[] {
