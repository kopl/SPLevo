 ...
 * <ul>
 *   <li>{@link org.splevo.diffing.java.modisco.java2kdmdiff.impl.MethodDeleteImpl#getMethodRight <em>Method Right</em>}</li>
 *   <li>{@link org.splevo.diffing.java.modisco.java2kdmdiff.impl.MethodDeleteImpl#getLeftContainer <em>Left Container</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
			...
			if (methodRight != oldMethodRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Java2KDMDiffPackage.METHOD_DELETE__METHOD_RIGHT,
	...
	public ASTNode getLeftContainer() {
		if (leftContainer != null && leftContainer.eIsProxy()) {
			...
			if (leftContainer != oldLeftContainer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Java2KDMDiffPackage.METHOD_DELETE__LEFT_CONTAINER,
