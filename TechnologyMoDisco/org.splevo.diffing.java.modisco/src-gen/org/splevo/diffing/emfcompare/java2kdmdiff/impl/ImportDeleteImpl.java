...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Import Delete</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.ImportDeleteImpl#getImportRight <em>
 * Import Right</em>}</li>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.ImportDeleteImpl#getLeftContainer <em>
...
public class ImportDeleteImpl extends ImportDeclarationChangeImpl implements ImportDelete {
            ...
            if (importRight != oldImportRight) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Java2KDMDiffPackage.IMPORT_DELETE__IMPORT_RIGHT, oldImportRight, importRight));
            }
        }
        return importRight;
    }
    ...
    public void setImportRight(ImportDeclaration newImportRight) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.IMPORT_DELETE__IMPORT_RIGHT,
    ...
    public CompilationUnit getLeftContainer() {
        if (leftContainer != null && leftContainer.eIsProxy()) {
            ...
            if (leftContainer != oldLeftContainer) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Java2KDMDiffPackage.IMPORT_DELETE__LEFT_CONTAINER, oldLeftContainer, leftContainer));
            }
        }
    ...
    public void setLeftContainer(CompilationUnit newLeftContainer) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.IMPORT_DELETE__LEFT_CONTAINER,
    ...
    /**
     * <!-- begin-user-doc --> The difference kind of an import delete is always
