 ...
 * <ul>
 * <li>
 * {@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.ImplementsInterfaceDeleteImpl#getImplementedInterface
 * <em>Implemented Interface</em>}</li>
 * <li>
 * {@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.ImplementsInterfaceDeleteImpl#getChangedClass
...
public class ImplementsInterfaceDeleteImpl extends ClassChangeImpl implements ImplementsInterfaceDelete {
            ...
            if (implementedInterface != oldImplementedInterface) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__IMPLEMENTED_INTERFACE,
    ...
    public void setImplementedInterface(InterfaceDeclaration newImplementedInterface) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__IMPLEMENTED_INTERFACE, oldImplementedInterface,
    ...
    public ClassDeclaration getChangedClass() {
        if (changedClass != null && changedClass.eIsProxy()) {
            ...
            if (changedClass != oldChangedClass) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__CHANGED_CLASS, oldChangedClass,
                            changedClass));
            }
        }
        return changedClass;
    ...
    public void setChangedClass(ClassDeclaration newChangedClass) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Java2KDMDiffPackage.IMPLEMENTS_INTERFACE_DELETE__CHANGED_CLASS, oldChangedClass, changedClass));
    }
    ...
    /**
     * <!-- begin-user-doc --> The difference kind of an implements interface delete is always
