 ...
 * <ul>
 * <li>
 * {@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.Java2KDMDiffExtensionImpl#getSubDiffElements
 * <em>Sub Diff Elements</em>}</li>
 * <li>
 * {@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.Java2KDMDiffExtensionImpl#getIsHiddenBy
 * <em>Is Hidden By</em>}</li>
 * <li>
 * {@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.Java2KDMDiffExtensionImpl#isConflicting
 * <em>Conflicting</em>}</li>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.Java2KDMDiffExtensionImpl#getKind <em>
 * Kind</em>}</li>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.Java2KDMDiffExtensionImpl#isRemote
 * <em>Remote</em>}</li>
 * <li>{@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.Java2KDMDiffExtensionImpl#getRequires
 * <em>Requires</em>}</li>
 * <li>
 * {@link org.splevo.diffing.emfcompare.java2kdmdiff.impl.Java2KDMDiffExtensionImpl#getRequiredBy
...
public abstract class Java2KDMDiffExtensionImpl extends AbstractDiffExtensionImpl implements Java2KDMDiffExtension {
    /**
     * The cached value of the '{@link #getSubDiffElements() <em>Sub Diff Elements</em>}'
    ...
    public EList<AbstractDiffExtension> getIsHiddenBy() {
        if (isHiddenBy == null) {
            isHiddenBy = new EObjectWithInverseResolvingEList.ManyInverse<AbstractDiffExtension>(
                    AbstractDiffExtension.class, this, Java2KDMDiffPackage.JAVA2_KDM_DIFF_EXTENSION__IS_HIDDEN_BY,
    ...
    public void setRemote(boolean newRemote) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Java2KDMDiffPackage.JAVA2_KDM_DIFF_EXTENSION__REMOTE,
                    oldRemote, remote));
    }
    ...
    public EList<DiffElement> getRequires() {
        if (requires == null) {
            requires = new EObjectWithInverseResolvingEList.ManyInverse<DiffElement>(DiffElement.class, this,
                    Java2KDMDiffPackage.JAVA2_KDM_DIFF_EXTENSION__REQUIRES, DiffPackage.DIFF_ELEMENT__REQUIRED_BY);
        }
        return requires;
    }
    ...
    public EList<DiffElement> getRequiredBy() {
        if (requiredBy == null) {
            requiredBy = new EObjectWithInverseResolvingEList.ManyInverse<DiffElement>(DiffElement.class, this,
                    Java2KDMDiffPackage.JAVA2_KDM_DIFF_EXTENSION__REQUIRED_BY, DiffPackage.DIFF_ELEMENT__REQUIRES);
        }
        return requiredBy;
    }
