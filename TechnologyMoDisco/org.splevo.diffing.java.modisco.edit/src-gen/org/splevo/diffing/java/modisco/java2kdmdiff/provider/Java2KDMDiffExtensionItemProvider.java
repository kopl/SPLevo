 ...
 * @generated
 */
public class Java2KDMDiffExtensionItemProvider extends
		AbstractDiffExtensionItemProvider implements
	...
	protected void addIsHiddenByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DiffElement_isHiddenBy_feature",
						"_UI_DiffElement_type"),
				DiffPackage.Literals.DIFF_ELEMENT__IS_HIDDEN_BY, true, false,
				true, null, null, null));
	}
	...
	protected void addConflictingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DiffElement_conflicting_feature",
						"_UI_DiffElement_type"),
				DiffPackage.Literals.DIFF_ELEMENT__CONFLICTING, false, false,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_DiffElement_kind_feature",
								"_UI_DiffElement_type"),
						DiffPackage.Literals.DIFF_ELEMENT__KIND, false, false,
	...
	protected void addRemotePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DiffElement_remote_feature",
						"_UI_DiffElement_type"),
	...
	protected void addRequiresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DiffElement_requires_feature",
						"_UI_DiffElement_type"),
				DiffPackage.Literals.DIFF_ELEMENT__REQUIRES, true, false, true,
				null, null, null));
	}
	...
	protected void addRequiredByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DiffElement_requiredBy_feature",
						"_UI_DiffElement_type"),
				DiffPackage.Literals.DIFF_ELEMENT__REQUIRED_BY, true, false,
				true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Java2KDMDiffExtension_type") + " "
				+ java2KDMDiffExtension.isIsCollapsed();
	}
