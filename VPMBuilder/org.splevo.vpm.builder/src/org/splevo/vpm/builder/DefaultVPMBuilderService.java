...
public class DefaultVPMBuilderService implements VPMBuilderService {
	...
	@Override
	public VariationPointModel buildVPM(DiffModel diffModel, String variantIDLeading, String variantIDIntegration, Map<String, Object> builderOptions)
		...
		// TODO Implement using all builders.
		return builders.get(0).buildVPM(diffModel, variantIDLeading, variantIDIntegration);
	}
		...
		for (IExtension extension : extensions) {
			...
			for (IConfigurationElement element : configurations) {
				try {
					...
					logger.error(
							"Failed to load VPM builder extension",
							e);
				}
			}
		}
