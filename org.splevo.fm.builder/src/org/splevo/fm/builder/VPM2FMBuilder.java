...
/**
 * A FeatureModel (FM) builder that derives the FM from an 
 * existing variation point model (VPM).
 *
 */
public class VPM2FMBuilder {
	 ...
	 * VariationPoint and one ChildFeature per Variant.
	 * The connection is always alternative (OR).
	 * 
	 * @param vpm The variation point model to make use of.
	 ...
	 * 
	 * @param variantId The variant to create the feature for.
	 * @return
	 */
	...
	/**
	 * Create a feature for a variation point and attach it with
	 * a mandatory group to the supplied root.
	 * 
	 * @param variationPointGroup The variation point to create the feature for.
	 * @param parentFeature The feature to attach the group to.
	 ...
	 * @param vpm The vpm to init the fm for.
