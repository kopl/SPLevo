package org.splevo.jamopp.refactoring.java.ifelse.or;
 ...
 */
public class IfElseStaticConfigClassStatementOR implements VariabilityRefactoring {

    private static final String REFACTORING_NAME = "IF-Else with Static Configuration Class (OR): Statement";
    private static final String REFACTORING_ID = 
            "org.splevo.jamopp.refactoring.java.ifelse.xor.IfElseStaticConfigClassStatementOR";
    ...
    public void refactor(VariationPoint vp) {
        ...
        for (Variant variant : variants) {
            ...
            if (vp.getVariants().indexOf(variant) == (vp.getVariants().size() - 1)) {
                vpLocation.getStatements().add(indexEndVariant,
                        SPLConfigurationUtil.generateORVerificationCondition(vp));
            }
        }
    ...
    public boolean canBeAppliedTo(VariationPoint variationPoint) {
        ...
        boolean correctVariabilityType = variationPoint.getVariabilityType() == VariabilityType.OR;
