 ...
 */
public class IfElseStaticConfigClassStatementXOR implements VariabilityRefactoring {

    private static final String REFACTORING_NAME = "IF-Else with Static Configuration Class (XOR): Statement";
    private static final String REFACTORING_ID = 
            "org.splevo.jamopp.refactoring.java.ifelse.xor.IfElseStaticConfigClassStatementXOR";
    ...
    public void refactor(VariationPoint vp) {
        ...
        for (Variant variant : variants) {
            ...
            if (previousCondition == null) {
                ...
                if (variants.indexOf(variant) == (variants.size() - 1)) {
                    currentCondition.setElseStatement(SPLConfigurationUtil.generateBlockThrowingARuntimeException());
                }
            }
