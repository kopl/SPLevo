 ...
 */
public class IfElseStaticConfigClassConstructorOPTXOR implements VariabilityRefactoring {

    private static final String REFACTORING_NAME = "IF-Else with Static Configuration Class (OPTXOR): Constructor";
    private static final String REFACTORING_ID = 
            "org.splevo.jamopp.refactoring.java.ifelse.xor.IfElseStaticConfigClassConstructorOPTXOR";
