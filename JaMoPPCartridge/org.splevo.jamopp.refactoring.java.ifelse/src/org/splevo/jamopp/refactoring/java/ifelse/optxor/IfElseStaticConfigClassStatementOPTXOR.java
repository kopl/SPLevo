 ...
 */
public class IfElseStaticConfigClassStatementOPTXOR implements VariabilityRefactoring {
    ...
    private static final String REFACTORING_ID = 
            "org.splevo.jamopp.refactoring.java.ifelse.xor.IfElseStaticConfigClassStatementOPTXOR";
