 ...
 */
public class IfElseStaticConfigClassConstructorOR implements VariabilityRefactoring {

    private static final String REFACTORING_NAME = "IF-Else with Static Configuration Class (OR): Constructor";
    private static final String REFACTORING_ID = 
            "org.splevo.jamopp.refactoring.java.ifelse.xor.IfElseStaticConfigClassConstructorOR";
    ...
    public boolean canBeAppliedTo(VariationPoint variationPoint) {
        ...
        boolean allImplementingElementsAreConstructors = 
                RefactoringUtil.allImplementingElementsOfType(variationPoint, Constructor.class);
