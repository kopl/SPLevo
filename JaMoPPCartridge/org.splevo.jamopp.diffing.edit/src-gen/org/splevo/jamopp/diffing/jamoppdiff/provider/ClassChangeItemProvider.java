...
public class ClassChangeItemProvider extends JaMoPPDiffItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addChangedClassPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ClassChange_changedClass_feature",
                        "_UI_ClassChange_type"), JaMoPPDiffPackage.Literals.CLASS_CHANGE__CHANGED_CLASS, true, false,
                true, null, null, null));
    }
    ...
    public String getText(Object object) {
        DifferenceKind labelValue = ((ClassChange) object).getKind();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString("_UI_ClassChange_type")
                : getString("_UI_ClassChange_type") + " " + label;
    }
