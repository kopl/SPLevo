...
public class ClassDeclarationTest {
	...
	public static void initTest() throws Exception {
		...
		List<URI> urisA = Lists.asList(URI.createFileURI(basePath + "a"),
				new URI[] {});
		List<URI> urisB = Lists.asList(URI.createFileURI(basePath + "b"),
				new URI[] {});
	...
	public void testDoDiff() throws Exception {
		...
		for (Diff diffElement : differences) {
			...
			if (diffElement instanceof ClassChange) {
				...
				org.emftext.language.java.classifiers.Class classDecl = classChange
						.getChangedClass();
				...
				assertThat("wrong difference type", unitChange.getKind(),
						equalTo(DifferenceKind.ADD));
				assertThat(
				...
				org.emftext.language.java.containers.Package packageDeclaration = packageChange
						.getChangedPackage();
				assertThat("wrong difference type", packageChange.getKind(),
						equalTo(DifferenceKind.ADD));
				assertThat("Unexpected package added",
	...
	public void testDoDiffReverse() throws Exception {
		...
		for (Diff diffElement : differences) {
			if (diffElement instanceof ClassChange) {
				...
				assertThat("wrong difference type", packageChange.getKind(),
						equalTo(DifferenceKind.DELETE));
				assertThat("Unexpected package deleted",
						packageDeclaration.getName(),
						anyOf(equalTo("newpackage"), equalTo("sub")));
