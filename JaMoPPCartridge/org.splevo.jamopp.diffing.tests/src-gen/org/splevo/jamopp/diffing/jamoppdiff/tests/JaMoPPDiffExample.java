...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>jamoppdiff</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class JaMoPPDiffExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(JaMoPPDiffPackage.eNS_URI,
				JaMoPPDiffPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.jamoppdiff"));
				StatementChange root = JaMoPPDiffFactory.eINSTANCE
						.createStatementChange();
