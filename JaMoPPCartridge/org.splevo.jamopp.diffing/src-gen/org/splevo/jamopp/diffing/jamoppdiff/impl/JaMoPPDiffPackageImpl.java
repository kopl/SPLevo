 ...
 * @generated
 */
public class JaMoPPDiffPackageImpl extends EPackageImpl implements
		JaMoPPDiffPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public static JaMoPPDiffPackage init() {
		if (isInited)
			return (JaMoPPDiffPackage) EPackage.Registry.INSTANCE
					.getEPackage(JaMoPPDiffPackage.eNS_URI);

		// Obtain or create and register package
		JaMoPPDiffPackageImpl theJaMoPPDiffPackage = (JaMoPPDiffPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof JaMoPPDiffPackageImpl ? EPackage.Registry.INSTANCE
		...
		EPackage.Registry.INSTANCE.put(JaMoPPDiffPackage.eNS_URI,
				theJaMoPPDiffPackage);
	...
	public EReference getCompilationUnitChange_ChangedCompilationUnit() {
		return (EReference) compilationUnitChangeEClass
	...
	public EReference getInterfaceChange_ChangedInterface() {
		return (EReference) interfaceChangeEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(statementChangeEClass,
				STATEMENT_CHANGE__CHANGED_STATEMENT);
		...
		createEReference(compilationUnitChangeEClass,
				COMPILATION_UNIT_CHANGE__CHANGED_COMPILATION_UNIT);

		interfaceChangeEClass = createEClass(INTERFACE_CHANGE);
		createEReference(interfaceChangeEClass,
				INTERFACE_CHANGE__CHANGED_INTERFACE);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(jaMoPPDiffEClass, JaMoPPDiff.class, "JaMoPPDiff",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(statementChangeEClass, StatementChange.class,
				"StatementChange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStatementChange_ChangedStatement(),
				theStatementsPackage.getStatement(), null, "changedStatement",
				null, 1, 1, StatementChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(importChangeEClass, ImportChange.class, "ImportChange",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImportChange_ChangedImport(),
				theImportsPackage.getImport(), null, "changedImport", null, 1,
				1, ImportChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classChangeEClass, ClassChange.class, "ClassChange",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClassChange_ChangedClass(),
				theClassifiersPackage.getClass_(), null, "changedClass", null,
				1, 1, ClassChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(fieldChangeEClass, FieldChange.class, "FieldChange",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFieldChange_ChangedField(),
				theMembersPackage.getField(), null, "changedField", null, 1, 1,
				FieldChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(packageChangeEClass, PackageChange.class, "PackageChange",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackageChange_ChangedPackage(),
				theContainersPackage.getPackage(), null, "changedPackage",
				null, 1, 1, PackageChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(methodChangeEClass, MethodChange.class, "MethodChange",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMethodChange_ChangedMethod(),
				theMembersPackage.getMethod(), null, "changedMethod", null, 1,
				1, MethodChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(enumChangeEClass, EnumChange.class, "EnumChange",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnumChange_ChangedEnum(),
				theClassifiersPackage.getEnumeration(), null, "changedEnum",
				null, 1, 1, EnumChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(compilationUnitChangeEClass, CompilationUnitChange.class,
				"CompilationUnitChange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCompilationUnitChange_ChangedCompilationUnit(),
				theContainersPackage.getCompilationUnit(), null,
				"changedCompilationUnit", null, 1, 1,
				CompilationUnitChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(interfaceChangeEClass, InterfaceChange.class,
				"InterfaceChange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInterfaceChange_ChangedInterface(),
				theClassifiersPackage.getInterface(), null, "changedInterface",
				null, 1, 1, InterfaceChange.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
