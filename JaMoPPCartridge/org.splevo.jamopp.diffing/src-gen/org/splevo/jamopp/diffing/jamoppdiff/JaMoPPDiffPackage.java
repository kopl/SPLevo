...
public interface JaMoPPDiffPackage extends EPackage {
	 ...
	 * @generated
	 */
	JaMoPPDiffPackage eINSTANCE = org.splevo.jamopp.diffing.jamoppdiff.impl.JaMoPPDiffPackageImpl
			.init();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference STATEMENT_CHANGE__CHANGED_STATEMENT = eINSTANCE
				.getStatementChange_ChangedStatement();
		 ...
		 * @generated
		 */
		EReference IMPORT_CHANGE__CHANGED_IMPORT = eINSTANCE
				.getImportChange_ChangedImport();
		 ...
		 * @generated
		 */
		EReference CLASS_CHANGE__CHANGED_CLASS = eINSTANCE
				.getClassChange_ChangedClass();
		 ...
		 * @generated
		 */
		EReference FIELD_CHANGE__CHANGED_FIELD = eINSTANCE
				.getFieldChange_ChangedField();
		 ...
		 * @generated
		 */
		EReference PACKAGE_CHANGE__CHANGED_PACKAGE = eINSTANCE
				.getPackageChange_ChangedPackage();
		 ...
		 * @generated
		 */
		EReference METHOD_CHANGE__CHANGED_METHOD = eINSTANCE
				.getMethodChange_ChangedMethod();
		 ...
		 * @generated
		 */
		EReference ENUM_CHANGE__CHANGED_ENUM = eINSTANCE
				.getEnumChange_ChangedEnum();
		 ...
		 * @generated
		 */
		EReference INTERFACE_CHANGE__CHANGED_INTERFACE = eINSTANCE
				.getInterfaceChange_ChangedInterface();
