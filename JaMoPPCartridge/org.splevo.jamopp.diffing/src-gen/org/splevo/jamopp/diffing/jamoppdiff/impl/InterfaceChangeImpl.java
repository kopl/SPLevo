 ...
 * @generated
 */
public class InterfaceChangeImpl extends JaMoPPDiffImpl implements
		InterfaceChange {
	/**
			...
			if (changedInterface != oldChangedInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							JaMoPPDiffPackage.INTERFACE_CHANGE__CHANGED_INTERFACE,
							oldChangedInterface, changedInterface));
			}
		}
