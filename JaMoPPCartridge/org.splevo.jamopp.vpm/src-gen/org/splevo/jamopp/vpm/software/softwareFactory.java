...
public interface softwareFactory extends EFactory {
     ...
     * @generated
     */
    softwareFactory eINSTANCE = org.splevo.jamopp.vpm.software.impl.softwareFactoryImpl.init();

    /**
     * Returns a new object of class '<em>Ja Mo PP Software Element</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Commentable Software Element</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
