...
import org.splevo.jamopp.refactoring.java.ifelse.IfElseRefactoringDifferentTypeVariables;
...
/**
 * Tests the {@link IfElseRefactoringDifferentTypeVariables} class. Checks whether variables of same
 * name and different types get handles correctly.
 */
public class IfElseRefactoringDifferentTypeVariablesTest {
    ...
    public void testCanBeAppliedForCaseReusedStatementDifferentTypeOPTOR() throws Exception {
        // init test object
        VariabilityRefactoring objectUnderTest = new IfElseRefactoringDifferentTypeVariables();
     ...
     */
    @Test
    public void testConditionForCaseStatementReusedStatementDifferentTypeOPTOR() throws Exception {
        // init test object
        VariabilityRefactoring objectUnderTest = new IfElseRefactoringDifferentTypeVariables();
     ...
     * 
     * <strong>Test Details</strong><br>
     * The refactored method body should contain one conditions with another condition as else, each containing the method that
     * executes all statements of a variant.
     * 
     * @throws Exception
     *             An unexpected failure during the test execution.
     */
    @Test
    public void testConditionForCaseStatementReusedStatementDifferentTypeOPTXOR() throws Exception {
        // init test object
        VariabilityRefactoring objectUnderTest = new IfElseRefactoringDifferentTypeVariables();
