...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>software</b></em>'
...
public class softwareExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(softwarePackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.software"));
				JaMoPPSoftwareElement root = softwareFactory.eINSTANCE
