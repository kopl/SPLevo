...
/**
 * This is the action bar contributor for the software model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class softwareActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    protected IAction showPropertiesViewAction = new Action(
            JaMoPPVPMEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
    ...
    protected IAction refreshViewerAction = new Action(
            JaMoPPVPMEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                JaMoPPVPMEditorPlugin.INSTANCE.getString("_UI_softwareEditor_menu"),
                "org.splevo.jamopp.vpm.softwareMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(JaMoPPVPMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(
                JaMoPPVPMEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(JaMoPPVPMEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(JaMoPPVPMEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
