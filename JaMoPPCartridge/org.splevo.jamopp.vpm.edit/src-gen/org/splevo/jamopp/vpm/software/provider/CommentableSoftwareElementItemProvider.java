 ...
 * {@link org.splevo.jamopp.vpm.software.CommentableSoftwareElement} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class CommentableSoftwareElementItemProvider extends ItemProviderAdapter
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_CommentableSoftwareElement_id_feature",
						"_UI_CommentableSoftwareElement_type"),
				softwarePackage.Literals.COMMENTABLE_SOFTWARE_ELEMENT__ID,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_CommentableSoftwareElement_type"),
						softwarePackage.Literals.COMMENTABLE_SOFTWARE_ELEMENT__COMPILATION_UNIT,
						true, false, true, null, null, null));
	}

	/**
	 * This returns CommentableSoftwareElement.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/CommentableSoftwareElement"));
	}
	...
	public String getText(Object object) {
		String label = ((CommentableSoftwareElement) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_CommentableSoftwareElement_type")
				: getString("_UI_CommentableSoftwareElement_type") + " "
						+ label;
	}
