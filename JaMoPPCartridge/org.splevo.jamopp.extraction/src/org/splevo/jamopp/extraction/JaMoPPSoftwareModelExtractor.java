...
public class JaMoPPSoftwareModelExtractor implements SoftwareModelExtractor {
	...
	/**
	 * Extract the source model of a list of java projects. One project is the
	 * main project while a list of additional projects to analyze can be
	 * specified. The reason for one main project is, that this one is used for
	 * example for the naming of the root inventory produced etc.
	 * 
	 * @param projectPaths
	...
	/**
	 * Load all java files found in a project into a ResourceSet and return the
	...
	/**
	 * Get the reference cache of the JaMoPP java resource factory registered in
	 * a resource set.
	 * 
	 * @param resourceSet
	 ...
	 * java resource type.
	 * 
	 * The jar files contained in the extracted projects are registered to the
	 * class path as well.
	 * 
	...
	private ResourceSet setUpResourceSet(String sourceModelDirectory, List<String> jarPaths) {
		...
		// options.put(IJavaOptions.DISABLE_LAYOUT_INFORMATION_RECORDING,
		// Boolean.TRUE);
