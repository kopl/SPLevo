...
/**
 * Unit test to prove the detected references between classifier usages and imports.
 */
public class ImportReferencesTest {

    private static final String BASE_PATH = "testcode/ImportReferences/";

    /** The logger for this class. */
    private Logger logger = Logger.getLogger(ImportReferencesTest.class);
    ...
    public void testVariableUsage() throws Exception {
        ...
        assertThat("Wrong number of dependencies", result.getEdgeDescriptors().size(), is(3));
