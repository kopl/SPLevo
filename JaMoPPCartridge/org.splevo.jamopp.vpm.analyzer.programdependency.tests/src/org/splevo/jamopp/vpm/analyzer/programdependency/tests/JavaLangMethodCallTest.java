 ...
 */
public class JavaLangMethodCallTest {

    private static final String BASE_PATH = "testcode/java.lang.methodcall/";

    /** The logger for this class. */
    private Logger logger = Logger.getLogger(JavaLangMethodCallTest.class);
    ...
    public void testVariableUsage() throws Exception {
        ...
        assertThat("Wrong number of dependencies", result.getEdgeDescriptors().size(), is(4));
