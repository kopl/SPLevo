...
/**
 * A java model specific reference check to interpret model references 
...
public class JavaModelReferenceCheck extends ReferencesCheck {
	 ...
	 * @param ignorePackages The list of patterns to filter our packages that should be ignored.
	 */
	 ...
	 * This method is an overloaded version of the shouldBeIgnored(EReference) to also interprete the 
	 * referencing element.
	 * 
	 * @param reference The reference to check.
	 * @param referencingElement The referencing element to include in the check.
