...
public class UnmatchedElementFilter {
	...
	/**
	 * The internal switch to check the unmatch element filtering according
	 * to the model element the unmatch element is about.
	 * It is based on the emf switch utilitiy class for the modisco java model.
	 *
	 */
	private class FilterSwitch extends JavaSwitch<Boolean>{
		
		/**
		 * Decide to always filter text elements.
		 * {@inheritDoc}
		 */
		@Override
