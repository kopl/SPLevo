 ...
 * <ul>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.ImportInsertImpl#getImportLeft <em>Import Left</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.ImportInsertImpl#getImportRight <em>Import Right</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.ImportInsertImpl#getCompilationUnitChange <em>Compilation Unit Change</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ImportInsertImpl extends KDM2JavaDiffExtensionImpl implements ImportInsert {
	/**
		...
		if (importLeft != null && importLeft.eIsProxy()) {
			...
			if (importLeft != oldImportLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KDM2JavaDiffPackage.IMPORT_INSERT__IMPORT_LEFT, oldImportLeft, importLeft));
			}
		}
		return importLeft;
	}
	...
	public void setImportLeft(ImportDeclaration newImportLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.IMPORT_INSERT__IMPORT_LEFT, oldImportLeft, importLeft));
	}
	...
	public CompilationUnitChange getCompilationUnitChange() {
		if (eContainerFeatureID() != KDM2JavaDiffPackage.IMPORT_INSERT__COMPILATION_UNIT_CHANGE) return null;
	...
	public NotificationChain basicSetCompilationUnitChange(CompilationUnitChange newCompilationUnitChange, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCompilationUnitChange, KDM2JavaDiffPackage.IMPORT_INSERT__COMPILATION_UNIT_CHANGE, msgs);
		return msgs;
	}
	...
	public void setCompilationUnitChange(CompilationUnitChange newCompilationUnitChange) {
		if (newCompilationUnitChange != eInternalContainer() || (eContainerFeatureID() != KDM2JavaDiffPackage.IMPORT_INSERT__COMPILATION_UNIT_CHANGE && newCompilationUnitChange != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.IMPORT_INSERT__COMPILATION_UNIT_CHANGE, newCompilationUnitChange, newCompilationUnitChange));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KDM2JavaDiffPackage.IMPORT_INSERT__COMPILATION_UNIT_CHANGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KDM2JavaDiffPackage.IMPORT_INSERT__IMPORT_LEFT:
