...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Method Parameter Change</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.MethodParameterChangeImpl#getMethodChange <em>Method Change</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.MethodParameterChangeImpl#getMethodDeclarationLeft <em>Method Declaration Left</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.MethodParameterChangeImpl#getMethodDeclarationRight <em>Method Declaration Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MethodParameterChangeImpl extends KDM2JavaDiffExtensionImpl implements MethodParameterChange {
	/**
	 ...
	 * @generated
	 */
	protected MethodParameterChangeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return KDM2JavaDiffPackage.Literals.METHOD_PARAMETER_CHANGE;
	}
	...
	public MethodChange getMethodChange() {
		if (eContainerFeatureID() != KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_CHANGE) return null;
	...
	public NotificationChain basicSetMethodChange(MethodChange newMethodChange, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newMethodChange, KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_CHANGE, msgs);
		return msgs;
	}
	...
	public void setMethodChange(MethodChange newMethodChange) {
		if (newMethodChange != eInternalContainer() || (eContainerFeatureID() != KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_CHANGE && newMethodChange != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_CHANGE, newMethodChange, newMethodChange));
	}
		...
		if (methodDeclarationLeft != null && methodDeclarationLeft.eIsProxy()) {
			...
			if (methodDeclarationLeft != oldMethodDeclarationLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_DECLARATION_LEFT, oldMethodDeclarationLeft, methodDeclarationLeft));
			}
		}
	...
	public void setMethodDeclarationLeft(MethodDeclaration newMethodDeclarationLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_DECLARATION_LEFT, oldMethodDeclarationLeft, methodDeclarationLeft));
	}
	...
	public MethodDeclaration getMethodDeclarationRight() {
		if (methodDeclarationRight != null && methodDeclarationRight.eIsProxy()) {
			...
			if (methodDeclarationRight != oldMethodDeclarationRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_DECLARATION_RIGHT, oldMethodDeclarationRight, methodDeclarationRight));
			}
		}
	...
	public void setMethodDeclarationRight(MethodDeclaration newMethodDeclarationRight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_DECLARATION_RIGHT, oldMethodDeclarationRight, methodDeclarationRight));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_DECLARATION_LEFT:
				if (resolve) return getMethodDeclarationLeft();
				return basicGetMethodDeclarationLeft();
			case KDM2JavaDiffPackage.METHOD_PARAMETER_CHANGE__METHOD_DECLARATION_RIGHT:
