 ...
 * <ul>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.StatementDeleteImpl#getStatementLeft <em>Statement Left</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.StatementDeleteImpl#getStatementRight <em>Statement Right</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.StatementDeleteImpl#getMethodChange <em>Method Change</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StatementDeleteImpl extends KDM2JavaDiffExtensionImpl implements StatementDelete {
	/**
	...
	protected EClass eStaticClass() {
		return KDM2JavaDiffPackage.Literals.STATEMENT_DELETE;
	}
		...
		if (statementLeft != null && statementLeft.eIsProxy()) {
			...
			if (statementLeft != oldStatementLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KDM2JavaDiffPackage.STATEMENT_DELETE__STATEMENT_LEFT, oldStatementLeft, statementLeft));
			}
		}
	...
	public void setStatementLeft(Statement newStatementLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.STATEMENT_DELETE__STATEMENT_LEFT, oldStatementLeft, statementLeft));
	}
	...
	public Statement getStatementRight() {
		if (statementRight != null && statementRight.eIsProxy()) {
			...
			if (statementRight != oldStatementRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KDM2JavaDiffPackage.STATEMENT_DELETE__STATEMENT_RIGHT, oldStatementRight, statementRight));
			}
		}
	...
	public void setStatementRight(Statement newStatementRight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.STATEMENT_DELETE__STATEMENT_RIGHT, oldStatementRight, statementRight));
	}
	...
	public MethodChange getMethodChange() {
		if (eContainerFeatureID() != KDM2JavaDiffPackage.STATEMENT_DELETE__METHOD_CHANGE) return null;
	...
	public NotificationChain basicSetMethodChange(MethodChange newMethodChange, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newMethodChange, KDM2JavaDiffPackage.STATEMENT_DELETE__METHOD_CHANGE, msgs);
		return msgs;
	}
	...
	public void setMethodChange(MethodChange newMethodChange) {
		if (newMethodChange != eInternalContainer() || (eContainerFeatureID() != KDM2JavaDiffPackage.STATEMENT_DELETE__METHOD_CHANGE && newMethodChange != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.STATEMENT_DELETE__METHOD_CHANGE, newMethodChange, newMethodChange));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KDM2JavaDiffPackage.STATEMENT_DELETE__METHOD_CHANGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KDM2JavaDiffPackage.STATEMENT_DELETE__STATEMENT_LEFT:
				if (resolve) return getStatementLeft();
				return basicGetStatementLeft();
			case KDM2JavaDiffPackage.STATEMENT_DELETE__STATEMENT_RIGHT:
