 ...
 * <ul>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.ClassInsertImpl#getClassLeft <em>Class Left</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.ClassInsertImpl#getClassRight <em>Class Right</em>}</li>
 *   <li>{@link org.splevo.diffing.emfcompare.kdm2javadiff.impl.ClassInsertImpl#getClassChange <em>Class Change</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassInsertImpl extends KDM2JavaDiffExtensionImpl implements ClassInsert {
	/**
	...
	protected EClass eStaticClass() {
		return KDM2JavaDiffPackage.Literals.CLASS_INSERT;
	}
		...
		if (classLeft != null && classLeft.eIsProxy()) {
			...
			if (classLeft != oldClassLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KDM2JavaDiffPackage.CLASS_INSERT__CLASS_LEFT, oldClassLeft, classLeft));
			}
		}
		return classLeft;
	}
	...
	public void setClassLeft(ClassDeclaration newClassLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.CLASS_INSERT__CLASS_LEFT, oldClassLeft, classLeft));
	}
	...
	public ClassDeclaration getClassRight() {
		if (classRight != null && classRight.eIsProxy()) {
			...
			if (classRight != oldClassRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KDM2JavaDiffPackage.CLASS_INSERT__CLASS_RIGHT, oldClassRight, classRight));
			}
		}
		return classRight;
	}
	...
	public void setClassRight(ClassDeclaration newClassRight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.CLASS_INSERT__CLASS_RIGHT, oldClassRight, classRight));
	}
	...
	public ClassChange getClassChange() {
		if (eContainerFeatureID() != KDM2JavaDiffPackage.CLASS_INSERT__CLASS_CHANGE) return null;
	...
	public NotificationChain basicSetClassChange(ClassChange newClassChange, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newClassChange, KDM2JavaDiffPackage.CLASS_INSERT__CLASS_CHANGE, msgs);
		return msgs;
	}
	...
	public void setClassChange(ClassChange newClassChange) {
		if (newClassChange != eInternalContainer() || (eContainerFeatureID() != KDM2JavaDiffPackage.CLASS_INSERT__CLASS_CHANGE && newClassChange != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, KDM2JavaDiffPackage.CLASS_INSERT__CLASS_CHANGE, newClassChange, newClassChange));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KDM2JavaDiffPackage.CLASS_INSERT__CLASS_CHANGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KDM2JavaDiffPackage.CLASS_INSERT__CLASS_LEFT:
				if (resolve) return getClassLeft();
				return basicGetClassLeft();
			case KDM2JavaDiffPackage.CLASS_INSERT__CLASS_RIGHT:
