 ...
 * <ul>
 *   <li>{@link org.splevo.diffing.java.modisco.java2kdmdiff.impl.PackageInsertImpl#getPackageLeft <em>Package Left</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageInsertImpl extends PackageChangeImpl implements
		PackageInsert {
	/**
			...
			if (packageLeft != oldPackageLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Java2KDMDiffPackage.PACKAGE_INSERT__PACKAGE_LEFT,
	 ...
	 * @generated
	 */
	public void setPackageLeft(
			org.eclipse.gmt.modisco.java.Package newPackageLeft) {
