 ...
 */
public class OpenVPMRefinementBrowserJob extends
	 ...
	 * 
	 * @param splevoProjectEditor The editor to trigger the process.
	 */
	...
	/**
	 * Build up the editor input with the analysis results 
	 * stored in the blackboard and start the refinement browser.
	 * {@inheritDoc}
	 */
	@Override
	public void execute(IProgressMonitor monitor)
		...
		try {
			VPMRefinementBrowserInput input = new VPMRefinementBrowserInput(getBlackboard().getAnalysisResults(),this.splevoProjectEditor);
			PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(input, VPMRefinementBrowser.ID);
	...
	/**
	 * No rollback required for this job.
	 */
	@Override
	...
	/**
	 * Get the speaking name of the job.
	 */
	@Override
