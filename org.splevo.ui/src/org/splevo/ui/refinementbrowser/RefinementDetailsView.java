...
public class RefinementDetailsView extends Composite {
    ...
    private static class ViewerLabelProvider extends LabelProvider {
         ...
         * Adapted to interpret the information of the specific type 
         * (VariationPoint, Variant, etc.)
         * 
         * {@inheritDoc}
         */
        @Override
        public String getText(Object element) {
            if (element instanceof VariationPoint) {
                return "VariationPoint in " + ((VariationPoint) element).getEnclosingSoftwareEntity().getClass().getSimpleName();
