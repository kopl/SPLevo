 ...
 * <ul>
 *   <li>{@link org.splevo.vpm.refinement.impl.MergeImpl#getVariationPoints <em>Variation Points</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MergeImpl extends RefinementImpl implements Merge {
	/**
	...
	protected EClass eStaticClass() {
		return RefinementPackage.Literals.MERGE;
	}
	...
	public EList<VariationPoint> getVariationPoints() {
		if (variationPoints == null) {
			variationPoints = new EObjectResolvingEList<VariationPoint>(VariationPoint.class, this, RefinementPackage.MERGE__VARIATION_POINTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefinementPackage.MERGE__VARIATION_POINTS:
