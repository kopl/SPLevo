...
public interface SoftwareModelExtractor {
    ...
    /**
     * Prepare a resource set for the specific software model under study.
     * This method can be used to register required resource factories etc.
     *
     * @param resourceSet The resource set to prepare.
     * @param sourceModelPaths The paths of the source models covered in this resource set.
     */
