...
import org.splevo.vpm.provider.vpmEditPlugin;
	...
	protected void addSoftwareEntitiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariationPoint_softwareEntities_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationPoint_softwareEntities_feature", "_UI_VariationPoint_type"),
				 variabilityPackage.Literals.VARIATION_POINT__SOFTWARE_ENTITIES,
				 true,
				 false,
				 true,
				 null,
