 ...
 * @generated
 */
public class VariationPointModelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationPointModel_leadingModel_feature", "_UI_VariationPointModel_type"),
				 variabilityPackage.Literals.VARIATION_POINT_MODEL__LEADING_MODEL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationPointModel_integrationModel_feature", "_UI_VariationPointModel_type"),
				 variabilityPackage.Literals.VARIATION_POINT_MODEL__INTEGRATION_MODEL,
				 true,
				 false,
				 true,
				 null,
