...
public final class ConfigDefaults {
	...
	public static final String DEFAULT_STOP_WORDS =	"get set new case remove class type create arg default configure clear value misc fig panel list element label the";
}
