 ...
 * end-user-doc -->
 * 
 * <!-- begin-model-doc --> A model containing all refinements identified for the variation point
 * model. <!-- end-model-doc -->
 * 
 * <p>
...
public interface RefinementModel extends EObject {
    /**
     * Returns the value of the '<em><b>Refinements</b></em>' containment reference list. The list
     * contents are of type {@link org.splevo.vpm.refinement.Refinement}. It is bidirectional and
     * its opposite is '{@link org.splevo.vpm.refinement.Refinement#getRefinementModel
     * <em>Refinement Model</em>}'. <!-- begin-user-doc -->
     * <p>
