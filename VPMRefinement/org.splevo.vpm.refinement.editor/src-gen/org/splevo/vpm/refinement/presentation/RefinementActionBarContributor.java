...
public class RefinementActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    protected IAction showPropertiesViewAction = new Action(
            RefinementEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
    ...
    protected IAction refreshViewerAction = new Action(
            RefinementEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                RefinementEditorPlugin.INSTANCE.getString("_UI_RefinementEditor_menu"),
                "org.splevo.vpm.refinementMenuID");
        ...
        createSiblingMenuManager = new MenuManager(
                RefinementEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
