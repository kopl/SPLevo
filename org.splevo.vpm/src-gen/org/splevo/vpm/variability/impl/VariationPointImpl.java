...
public class VariationPointImpl extends EObjectImpl implements VariationPoint {
    ...
    public ASTNode getEnclosingSoftwareEntity() {
        if (enclosingSoftwareEntity != null && enclosingSoftwareEntity.eIsProxy()) {
            ...
            if (enclosingSoftwareEntity != oldEnclosingSoftwareEntity) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, variabilityPackage.VARIATION_POINT__ENCLOSING_SOFTWARE_ENTITY, oldEnclosingSoftwareEntity, enclosingSoftwareEntity));
            }
        }
    ...
    public void setEnclosingSoftwareEntity(ASTNode newEnclosingSoftwareEntity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, variabilityPackage.VARIATION_POINT__ENCLOSING_SOFTWARE_ENTITY, oldEnclosingSoftwareEntity, enclosingSoftwareEntity));
    }
